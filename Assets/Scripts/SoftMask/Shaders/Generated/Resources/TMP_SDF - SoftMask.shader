...
SubShader {
	...
	Pass {
		...
		#include "Assets/Globals/TextMesh Pro/Shaders/TMPro_Properties.cginc"
		#include "Assets/Globals/TextMesh Pro/Shaders/TMPro.cginc"
		#include "Assets/Globals/SoftMask/Shaders/SoftMask.cginc" // Soft Mask
