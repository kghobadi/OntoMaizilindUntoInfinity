...
Shader "Julian/NoiseLandscape"
{
	...
	SubShader
	{
		...
		inline half4 LightingStandardCustomLighting( inout SurfaceOutputCustomLightingCustom s, half3 viewDir, UnityGI gi )
		{
			...
			half4 temp_output_87_0 = ( ( trunc( ( temp_cast_2 * temp_output_3_0_g41 ) ) / temp_output_3_0_g41 ) * ( ase_lightColor.a * ( trunc( ( temp_cast_3 * temp_output_3_0_g39 ) ) / temp_output_3_0_g39 ) ) );
			...
			half4 temp_cast_8 = (simplePerlin3D2).xxxx;
			...
			half4 lerpResult127 = lerp( CalculateContrast(_NoiseStrength,( ase_lightColor * simplePerlin3D2 )) , ase_lightColor , ( saturate( ( blendOpSrc146 + blendOpDest146 ) )));
...
/*ASEBEGIN
Version=18912
177;427;1628;677;586.476;573.87;1.653207;True;True
...
Node;AmplifyShaderEditor.NoiseGeneratorNode;2;11.53645,33.12886;Inherit;True;Simplex3D;False;False;2;0;FLOAT3;0,0,0;False;1;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;210;-60.21088,-91.30369;Inherit;False;Property;_MaximumHeight;MaximumHeight;11;0;Create;True;0;0;0;False;0;False;380;370;0;0;0;1;FLOAT;0
...
ASEEND*/
//CHKSM=E6C166165BE1F0BDE8F212AD9289C520FF0EE5BD