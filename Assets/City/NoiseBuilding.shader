...
Shader "Julian/NoiseBuilding"
{
	...
	SubShader
	{
		...
		inline half4 LightingStandardCustomLighting( inout SurfaceOutputCustomLightingCustom s, half3 viewDir, UnityGI gi )
		{
			...
			float2 uv_TexCoord78_g34 = i.uv_texcoord * float2( 2,2 );
			half2 temp_output_31_0_g34 = ( uv_TexCoord78_g34 - float2( 1,1 ) );
			...
			half temp_output_3_0_g35 = lightSteps77;
			...
			half4 temp_cast_5 = (saturate( dotResult79 )).xxxx;
			half temp_output_3_0_g33 = lightSteps77;
			half4 temp_cast_6 = (ase_lightAtten).xxxx;
			half temp_output_3_0_g27 = lightSteps77;
			half4 temp_output_87_0 = ( ( trunc( ( temp_cast_5 * temp_output_3_0_g33 ) ) / temp_output_3_0_g33 ) * ( ase_lightColor.a * ( trunc( ( temp_cast_6 * temp_output_3_0_g27 ) ) / temp_output_3_0_g27 ) ) );
			half4 lerpResult97 = lerp( ( ase_lightColor * ( trunc( ( temp_cast_3 * temp_output_3_0_g35 ) ) / temp_output_3_0_g35 ) ) , float4( 0,0,0,0 ) , saturate( ( 1.0 - temp_output_87_0 ) ));
			half4 light99 = lerpResult97;
			half4 lightLerp129 = temp_output_87_0;
			half4 temp_cast_8 = (_RemapValues.x).xxxx;
			half4 temp_cast_9 = (_RemapValues.y).xxxx;
			half4 temp_cast_10 = (_RemapValues.z).xxxx;
			half4 temp_cast_11 = (_RemapValues.w).xxxx;
			half4 temp_output_152_0 = ( temp_output_26_0 * 1.0 );
			half4 blendOpSrc146 = (temp_cast_10 + (lightLerp129 - temp_cast_8) * (temp_cast_11 - temp_cast_10) / (temp_cast_9 - temp_cast_8));
...
/*ASEBEGIN
Version=18912
121;837;1906;965;1582.226;-68.98387;1.38157;True;True
...
Node;AmplifyShaderEditor.RangedFloatNode;73;-418.6519,2076.66;Inherit;False;Property;_LightSteps;LightSteps;7;0;Create;True;0;0;0;False;0;False;4;3;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.Vector2Node;14;-1678.819,-224.9958;Float;False;Property;_WaveSize;WaveSize;3;0;Create;True;0;0;0;False;0;False;1,1;5,5;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
...
Node;AmplifyShaderEditor.Vector4Node;108;-1927.264,672.5759;Inherit;False;Property;_CircularNoiseTileAndSpeed;CircularNoiseTileAndSpeed;8;0;Create;True;0;0;0;False;0;False;0,10,0,0.1;0,5,0,0;0;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.FunctionNode;107;-1450.858,572.9877;Inherit;False;RadialUVDistortion;-1;;34;051d65e7699b41a4c800363fd0e822b2;0;7;60;SAMPLER2D;_Sampler60107;False;1;FLOAT2;1,1;False;11;FLOAT2;0,0;False;65;FLOAT;1;False;68;FLOAT2;0,1;False;47;FLOAT2;0,0.1;False;29;FLOAT2;0,0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.RangedFloatNode;6;-1485.776,415.8315;Float;False;Property;_WaveSpeed;WaveSpeed;0;0;Create;True;0;0;0;False;0;False;0;1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;85;-922.9891,1419.601;Inherit;False;PosterizeSteps;-1;;33;a5af708c0f358a1409563877edfc2aac;0;2;1;FLOAT4;0,0,0,0;False;3;FLOAT;3;False;1;FLOAT4;0
...
Node;AmplifyShaderEditor.RangedFloatNode;113;-1083.141,441.2784;Inherit;False;Property;_2NoiseContrast;2NoiseContrast;9;0;Create;True;0;0;0;False;0;False;1;1;1;6;0;1;FLOAT;0
Node;AmplifyShaderEditor.Vector2Node;4;-1449.096,139.0983;Float;False;Property;_WaveDirection;WaveDirection;1;0;Create;True;0;0;0;False;0;False;1,0;0,2;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
...
Node;AmplifyShaderEditor.FunctionNode;94;-455.1952,1391.657;Inherit;False;PosterizeSteps;-1;;35;a5af708c0f358a1409563877edfc2aac;0;2;1;FLOAT4;0,0,0,0;False;3;FLOAT;3;False;1;FLOAT4;0
...
Node;AmplifyShaderEditor.RangedFloatNode;115;-752.7813,674.5148;Inherit;False;Property;_2NoiseStrength;2NoiseStrength;10;0;Create;True;0;0;0;False;0;False;1;0.5;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.Vector4Node;165;114.2565,537.6131;Inherit;False;Property;_RemapValues;RemapValues;12;0;Create;True;0;0;0;False;0;False;0,1,0,1.2;0,1,0,0.5;0;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.ColorNode;31;845.8781,-357.0184;Inherit;False;Property;_Albedo;Albedo;5;0;Create;True;0;0;0;False;0;False;1,1,1,1;0.5849056,0.3265723,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;148;-90.32281,554.5864;Inherit;False;Constant;_Float0;Float 0;12;0;Create;True;0;0;0;False;0;False;1;1;0;0;0;1;FLOAT;0
...
ASEEND*/
//CHKSM=8A559DF1F5C096D8FCDD8E3B54359ABC8835F327