...
Shader "Julian/NoiseBuilding"
{
	...
	SubShader
	{
		...
		inline half4 LightingStandardCustomLighting( inout SurfaceOutputCustomLightingCustom s, half3 viewDir, UnityGI gi )
		{
			...
			half simplePerlin3D2 = snoise( ( ( half3(0,2,0) * mulTime172 ) + ( half3(1,1,1) * ase_worldPos ) )*_NoiseScale );
			...
			half4 temp_output_96_0 = ( ase_lightColor * ( trunc( ( temp_cast_3 * temp_output_3_0_g37 ) ) / temp_output_3_0_g37 ) );
			half4 lightColor157 = temp_output_96_0;
			...
			half temp_output_3_0_g36 = lightSteps77;
			half4 temp_cast_6 = (ase_lightAtten).xxxx;
			half temp_output_3_0_g35 = lightSteps77;
			half4 temp_output_87_0 = ( ( trunc( ( temp_cast_5 * temp_output_3_0_g36 ) ) / temp_output_3_0_g36 ) * ( ase_lightColor.a * ( trunc( ( temp_cast_6 * temp_output_3_0_g35 ) ) / temp_output_3_0_g35 ) ) );
			half4 lightLerp129 = temp_output_87_0;
			half4 temp_cast_7 = (_RemapValues.x).xxxx;
			half4 temp_cast_8 = (_RemapValues.y).xxxx;
			half4 temp_cast_9 = (_RemapValues.z).xxxx;
			half4 temp_cast_10 = (_RemapValues.w).xxxx;
			half4 blendOpSrc146 = (temp_cast_9 + (lightLerp129 - temp_cast_7) * (temp_cast_10 - temp_cast_9) / (temp_cast_8 - temp_cast_7));
			half4 blendOpDest146 = temp_output_179_0;
			half4 lerpResult127 = lerp( ( ase_lightColor * trunc( ( temp_output_179_0 * 2.0 ) ) ) , lightColor157 , ( saturate(  round( 0.5 * ( blendOpSrc146 + blendOpDest146 ) ) )));
...
/*ASEBEGIN
Version=18912
-20;195;1906;827;470.9599;54.76192;1.35621;True;True
...
Node;AmplifyShaderEditor.Vector4Node;108;-1927.264,672.5759;Inherit;False;Property;_CircularNoiseTileAndSpeed;CircularNoiseTileAndSpeed;7;0;Create;True;0;0;0;False;0;False;0,10,0,0.1;0,10,0,0.06;0;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.Vector3Node;170;-1554.377,-19.08035;Inherit;False;Constant;_NoiseDirection;NoiseDirection;14;0;Create;True;0;0;0;False;0;False;0,2,0;1,1,1;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
...
Node;AmplifyShaderEditor.FunctionNode;82;-1034.718,1886.406;Inherit;False;PosterizeSteps;-1;;35;a5af708c0f358a1409563877edfc2aac;0;2;1;FLOAT4;0,0,0,0;False;3;FLOAT;3;False;1;FLOAT4;0
...
Node;AmplifyShaderEditor.FunctionNode;85;-922.9891,1419.601;Inherit;False;PosterizeSteps;-1;;36;a5af708c0f358a1409563877edfc2aac;0;2;1;FLOAT4;0,0,0,0;False;3;FLOAT;3;False;1;FLOAT4;0
...
Node;AmplifyShaderEditor.FunctionNode;94;-455.1952,1391.657;Inherit;False;PosterizeSteps;-1;;37;a5af708c0f358a1409563877edfc2aac;0;2;1;FLOAT4;0,0,0,0;False;3;FLOAT;3;False;1;FLOAT4;0
...
Node;AmplifyShaderEditor.ColorNode;31;845.8781,-357.0184;Inherit;False;Property;_Albedo;Albedo;4;0;Create;True;0;0;0;False;0;False;1,1,1,1;0.6,0.3854015,0,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
ASEEND*/
//CHKSM=B3D5691F0B17AA7C9BA139AF4B977EF72F5DCA3E