...
Shader "Julian/NoiseBuilding"
{
	...
	SubShader
	{
		...
		inline half4 LightingStandardCustomLighting( inout SurfaceOutputCustomLightingCustom s, half3 viewDir, UnityGI gi )
		{
			...
			half2 temp_output_47_0_g40 = appendResult110;
			half2 appendResult188 = (half2(ase_worldPos.x , ase_worldPos.z));
			half2 temp_output_31_0_g40 = ( appendResult188 - float2( 1,1 ) );
			...
			half simplePerlin2D23 = snoise( ( ( (tex2D( _Sampler60107, ( appendResult10_g40 + appendResult24_g40 ) )).rg * 1.0 ) + ( appendResult109 * appendResult58_g40 ) ) );
			...
			half4 temp_output_179_0 = ( ( simplePerlin3D2 + ( CalculateContrast(_2NoiseContrast,temp_cast_0) * _2NoiseStrength ) ) - triplanar183 );
			...
			half4 temp_output_160_0 = (temp_cast_6 + (lightLerp129 - temp_cast_4) * (temp_cast_7 - temp_cast_6) / (temp_cast_5 - temp_cast_4));
...
/*ASEBEGIN
Version=18912
40;378;1906;1007;1716.543;483.2855;1.675141;True;True
...
Node;AmplifyShaderEditor.RangedFloatNode;73;-418.6519,2076.66;Inherit;False;Property;_LightSteps;LightSteps;2;0;Create;True;0;0;0;False;0;False;4;4;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.WorldPosInputsNode;186;-2153.057,555.5624;Inherit;False;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
Node;AmplifyShaderEditor.Vector4Node;108;-1927.264,672.5759;Inherit;False;Property;_CircularNoiseTileAndSpeed;CircularNoiseTileAndSpeed;3;0;Create;True;0;0;0;False;0;False;0,10,0,0.1;0,0.05,0,12;0;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;169;-1688.242,130.5841;Inherit;False;Property;_3DNoiseTime;3DNoiseTime;10;0;Create;True;0;0;0;False;0;False;0.2;0.1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.LightAttenuation;74;-1401.082,1888.376;Inherit;True;0;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;107;-1450.858,572.9877;Inherit;False;RadialUVDistortion;-1;;40;051d65e7699b41a4c800363fd0e822b2;0;7;60;SAMPLER2D;_Sampler60107;False;1;FLOAT2;1,1;False;11;FLOAT2;0,0;False;65;FLOAT;1;False;68;FLOAT2;5,5;False;47;FLOAT2;0,0.1;False;29;FLOAT2;0,0;False;1;FLOAT2;0
...
Node;AmplifyShaderEditor.NoiseGeneratorNode;23;-1015.579,527.9031;Inherit;True;Simplex2D;False;False;2;0;FLOAT2;0,0;False;1;FLOAT;1;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;85;-922.9891,1419.601;Inherit;True;PosterizeSteps;-1;;41;a5af708c0f358a1409563877edfc2aac;0;2;1;FLOAT4;0,0,0,0;False;3;FLOAT;3;False;1;FLOAT4;0
Node;AmplifyShaderEditor.RangedFloatNode;113;-1083.141,441.2784;Inherit;False;Property;_2NoiseContrast;2NoiseContrast;4;0;Create;True;0;0;0;False;0;False;1;1;0;6;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;177;-1009.679,232.8727;Inherit;False;Property;_NoiseScale;NoiseScale;8;0;Create;True;0;0;0;False;0;False;10;10;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;115;-752.7813,674.5148;Inherit;False;Property;_2NoiseStrength;2NoiseStrength;5;0;Create;True;0;0;0;False;0;False;1;0.8;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.Vector2Node;185;-654.7039,-311.697;Inherit;False;Property;_DetailTiling;DetailTiling;11;0;Create;True;0;0;0;False;0;False;1,1;0.04,0.04;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
Node;AmplifyShaderEditor.RegisterLocalVarNode;129;-174.1478,1855.483;Inherit;True;lightLerp;-1;True;1;0;FLOAT4;0,0,0,0;False;1;FLOAT4;0
...
Node;AmplifyShaderEditor.Vector4Node;165;130.8353,603.9285;Inherit;False;Property;_RemapValues;RemapValues;6;0;Create;True;0;0;0;False;0;False;0,1,0,1.2;0,0.6,0,1.6;0;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SamplerNode;168;764.2002,-178.9301;Inherit;True;Property;_MainTexture;MainTexture;7;0;Create;True;0;0;0;False;0;False;-1;None;ed07a62e2614afc4c9dbb7fbf9e542b0;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ColorNode;31;845.8781,-357.0184;Inherit;False;Property;_Albedo;Albedo;1;0;Create;True;0;0;0;False;0;False;1,1,1,1;0.4,0.253125,0,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.GetLocalVarNode;104;614.581,214.4938;Inherit;False;-1;;1;0;OBJECT;;False;1;COLOR;0
...
Node;AmplifyShaderEditor.SamplerNode;178;-326.4331,-131.951;Inherit;True;Property;_DetailTexture;DetailTexture;9;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
ASEEND*/
//CHKSM=49C672131A959CB1F80399A8B0427AC2141A29BA