...
Shader "Julian/NoiseBuilding"
{
	...
	SubShader
	{
		...
		inline half4 LightingStandardCustomLighting( inout SurfaceOutputCustomLightingCustom s, half3 viewDir, UnityGI gi )
		{
			...
			half dotResult4_g50 = dot( appendResult194 , half2( 12.9898,78.233 ) );
			half lerpResult10_g50 = lerp( 0.0 , 1.0 , frac( ( sin( dotResult4_g50 ) * 43758.55 ) ));
			...
			half2 temp_output_1_0_g48 = float2( 1,1 );
			half2 appendResult10_g48 = (half2(( (temp_output_1_0_g48).x * i.uv_texcoord.x ) , ( i.uv_texcoord.y * (temp_output_1_0_g48).y )));
			half2 temp_output_11_0_g48 = float2( 0,0 );
			half2 panner18_g48 = ( ( (temp_output_11_0_g48).x * _Time.y ) * float2( 1,0 ) + i.uv_texcoord);
			half2 panner19_g48 = ( ( _Time.y * (temp_output_11_0_g48).y ) * float2( 0,1 ) + i.uv_texcoord);
			half2 appendResult24_g48 = (half2((panner18_g48).x , (panner19_g48).y));
			...
			half2 temp_output_47_0_g48 = appendResult110;
			half2 appendResult188 = (half2(ase_worldPos.x , ase_worldPos.z));
			half2 temp_output_31_0_g48 = ( appendResult188 - float2( 1,1 ) );
			half2 appendResult39_g48 = (half2(frac( ( atan2( (temp_output_31_0_g48).x , (temp_output_31_0_g48).y ) / 6.28318548202515 ) ) , length( temp_output_31_0_g48 )));
			half2 panner54_g48 = ( ( (temp_output_47_0_g48).x * _Time.y ) * float2( 1,0 ) + appendResult39_g48);
			half2 panner55_g48 = ( ( _Time.y * (temp_output_47_0_g48).y ) * float2( 0,1 ) + appendResult39_g48);
			half2 appendResult58_g48 = (half2((panner54_g48).x , (panner55_g48).y));
			half simplePerlin2D23 = snoise( ( ( (tex2D( _Sampler60107, ( appendResult10_g48 + appendResult24_g48 ) )).rg * 1.0 ) + ( appendResult109 * appendResult58_g48 ) ) );
			...
			half temp_output_3_0_g49 = lightSteps77;
			...
			half4 lightLerp129 = ( ( trunc( ( temp_cast_1 * temp_output_3_0_g49 ) ) / temp_output_3_0_g49 ) * ( ase_lightColor.a * ( trunc( ( temp_cast_2 * temp_output_3_0_g47 ) ) / temp_output_3_0_g47 ) ) );
			...
			c.rgb = ( SampleGradient( gradient195, lerpResult10_g50 ) * tex2D( _MainTexture, uv_MainTexture ) * lerpResult190 * ase_lightColor * _Color0 ).rgb;
			c.a = 1;
			return c;
		}
...
/*ASEBEGIN
Version=18912
133;346;1619;673;42.94125;743.063;1.437003;True;True
...
Node;AmplifyShaderEditor.Vector4Node;108;-1641.47,601.7261;Inherit;False;Property;_CircularNoiseTileAndSpeed;CircularNoiseTileAndSpeed;1;0;Create;True;0;0;0;False;0;False;0,10,0,0.1;0,0.05,0,12;0;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;169;-1374.988,11.27485;Inherit;False;Property;_3DNoiseTime;3DNoiseTime;8;0;Create;True;0;0;0;False;0;False;0.2;0.1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;107;-1153.757,576.4424;Inherit;False;RadialUVDistortion;-1;;48;051d65e7699b41a4c800363fd0e822b2;0;7;60;SAMPLER2D;_Sampler60107;False;1;FLOAT2;1,1;False;11;FLOAT2;0,0;False;65;FLOAT;1;False;68;FLOAT2;5,5;False;47;FLOAT2;0,0.1;False;29;FLOAT2;0,0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.FunctionNode;82;-1034.718,1886.406;Inherit;False;PosterizeSteps;-1;;47;a5af708c0f358a1409563877edfc2aac;0;2;1;FLOAT4;0,0,0,0;False;3;FLOAT;3;False;1;FLOAT4;0
...
Node;AmplifyShaderEditor.FunctionNode;85;-922.9891,1419.601;Inherit;True;PosterizeSteps;-1;;49;a5af708c0f358a1409563877edfc2aac;0;2;1;FLOAT4;0,0,0,0;False;3;FLOAT;3;False;1;FLOAT4;0
Node;AmplifyShaderEditor.RangedFloatNode;113;-786.0399,444.733;Inherit;False;Property;_2NoiseContrast;2NoiseContrast;2;0;Create;True;0;0;0;False;0;False;1;1;0;6;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;177;-696.4246,113.5635;Inherit;False;Property;_NoiseScale;NoiseScale;6;0;Create;True;0;0;0;False;0;False;10;10;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;115;-455.6801,677.9695;Inherit;False;Property;_2NoiseStrength;2NoiseStrength;3;0;Create;True;0;0;0;False;0;False;1;0.8;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;201;-201.3271,-76.7146;Inherit;False;Property;_DetailContrast;DetailContrast;10;0;Create;True;0;0;0;False;0;False;1;2;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;178;-194.332,-296.4963;Inherit;True;Property;_DetailTexture;DetailTexture;7;0;Create;True;0;0;0;False;0;False;-1;None;9275d2b5c84e98549bfc320d33d06163;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.Vector4Node;165;135.8353,564.9285;Inherit;False;Property;_RemapValues;RemapValues;4;0;Create;True;0;0;0;False;0;False;0,1,0,1.2;0,0.6,1,1.6;0;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.FunctionNode;191;542.6517,-536.1615;Inherit;False;Random Range;-1;;50;7b754edb8aebbfb4a9ace907af661cfc;0;3;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT;1;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;168;764.2002,-178.9301;Inherit;True;Property;_MainTexture;MainTexture;5;0;Create;True;0;0;0;False;0;False;-1;None;ed07a62e2614afc4c9dbb7fbf9e542b0;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.ColorNode;199;817.8357,-344.7199;Inherit;False;Property;_Color0;Color 0;9;0;Create;True;0;0;0;False;0;False;1,1,1,0;1,1,1,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;189;1181.329,78.40897;Inherit;True;5;5;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;COLOR;0,0,0,0;False;3;COLOR;0,0,0,0;False;4;COLOR;0,0,0,0;False;1;COLOR;0
...
WireConnection;189;4;199;0
WireConnection;0;13;189;0
ASEEND*/
//CHKSM=95B33AA16FEE145D869A347D73CB70397089B8DB