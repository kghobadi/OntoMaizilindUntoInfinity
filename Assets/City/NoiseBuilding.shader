...
Shader "Julian/NoiseBuilding"
{
	...
	SubShader
	{
		...
		inline half4 LightingStandardCustomLighting( inout SurfaceOutputCustomLightingCustom s, half3 viewDir, UnityGI gi )
		{
			...
			half2 panner3 = ( ( _Time.y * _WaveSpeed ) * _WaveDirection + WaveTileUV20);
			half simplePerlin3D2 = snoise( half3( panner3 ,  0.0 ) );
			simplePerlin3D2 = simplePerlin3D2*0.5 + 0.5;
			half2 temp_output_1_0_g32 = float2( 1,1 );
			half2 appendResult10_g32 = (half2(( (temp_output_1_0_g32).x * i.uv_texcoord.x ) , ( i.uv_texcoord.y * (temp_output_1_0_g32).y )));
			half2 temp_output_11_0_g32 = float2( 0,0 );
			half2 panner18_g32 = ( ( (temp_output_11_0_g32).x * _Time.y ) * float2( 1,0 ) + i.uv_texcoord);
			half2 panner19_g32 = ( ( _Time.y * (temp_output_11_0_g32).y ) * float2( 0,1 ) + i.uv_texcoord);
			half2 appendResult24_g32 = (half2((panner18_g32).x , (panner19_g32).y));
			...
			half2 temp_output_47_0_g32 = appendResult110;
			float2 uv_TexCoord78_g32 = i.uv_texcoord * float2( 2,2 );
			half2 temp_output_31_0_g32 = ( uv_TexCoord78_g32 - float2( 1,1 ) );
			half2 appendResult39_g32 = (half2(frac( ( atan2( (temp_output_31_0_g32).x , (temp_output_31_0_g32).y ) / 6.28318548202515 ) ) , length( temp_output_31_0_g32 )));
			half2 panner54_g32 = ( ( (temp_output_47_0_g32).x * _Time.y ) * float2( 1,0 ) + appendResult39_g32);
			half2 panner55_g32 = ( ( _Time.y * (temp_output_47_0_g32).y ) * float2( 0,1 ) + appendResult39_g32);
			half2 appendResult58_g32 = (half2((panner54_g32).x , (panner55_g32).y));
			half simplePerlin3D23 = snoise( half3( ( ( (tex2D( _Sampler60107, ( appendResult10_g32 + appendResult24_g32 ) )).rg * 1.0 ) + ( appendResult109 * appendResult58_g32 ) ) ,  0.0 ) );
			half4 temp_cast_3 = (simplePerlin3D23).xxxx;
			half4 temp_output_26_0 = ( simplePerlin3D2 + ( CalculateContrast(_2NoiseContrast,temp_cast_3) * _2NoiseStrength ) );
			half4 temp_cast_4 = (ase_lightAtten).xxxx;
			half lightSteps77 = _LightSteps;
			half temp_output_3_0_g33 = lightSteps77;
			...
			half4 temp_cast_6 = (saturate( dotResult79 )).xxxx;
			half temp_output_3_0_g28 = lightSteps77;
			half4 temp_cast_7 = (ase_lightAtten).xxxx;
			half temp_output_3_0_g27 = lightSteps77;
			half4 temp_output_87_0 = ( ( trunc( ( temp_cast_6 * temp_output_3_0_g28 ) ) / temp_output_3_0_g28 ) * ( ase_lightColor.a * ( trunc( ( temp_cast_7 * temp_output_3_0_g27 ) ) / temp_output_3_0_g27 ) ) );
			half4 lerpResult97 = lerp( ( ase_lightColor * ( trunc( ( temp_cast_4 * temp_output_3_0_g33 ) ) / temp_output_3_0_g33 ) ) , float4( 0,0,0,0 ) , saturate( ( 1.0 - temp_output_87_0 ) ));
			half4 light99 = lerpResult97;
			half4 lightLerp129 = temp_output_87_0;
			half4 temp_cast_9 = (_RemapValues.x).xxxx;
			half4 temp_cast_10 = (_RemapValues.y).xxxx;
			half4 temp_cast_11 = (_RemapValues.z).xxxx;
			half4 temp_cast_12 = (_RemapValues.w).xxxx;
			half4 temp_output_152_0 = ( temp_output_26_0 * 1.0 );
			half4 blendOpSrc146 = (temp_cast_11 + (( lightLerp129 * 1.0 ) - temp_cast_9) * (temp_cast_12 - temp_cast_11) / (temp_cast_10 - temp_cast_9));
			half4 blendOpDest146 = temp_output_152_0;
			half4 lerpResult127 = lerp( ( ase_lightColor * temp_output_26_0 ) , light99 , ( saturate(  round( 0.5 * ( blendOpSrc146 + blendOpDest146 ) ) )));
...
/*ASEBEGIN
Version=18912
14;244;1906;673;-14.20016;531.9301;1;True;True
...
Node;AmplifyShaderEditor.RangedFloatNode;73;-418.6519,2076.66;Inherit;False;Property;_LightSteps;LightSteps;7;0;Create;True;0;0;0;False;0;False;4;4;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;16;-1326.441,-162.1133;Float;False;Property;_WaveTile;WaveTile;2;0;Create;True;0;0;0;False;0;False;1;10000;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.Vector4Node;108;-1927.264,672.5759;Inherit;False;Property;_CircularNoiseTileAndSpeed;CircularNoiseTileAndSpeed;8;0;Create;True;0;0;0;False;0;False;0,10,0,0.1;0,10,0,0.06;0;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.FunctionNode;82;-1034.718,1886.406;Inherit;False;PosterizeSteps;-1;;27;a5af708c0f358a1409563877edfc2aac;0;2;1;FLOAT4;0,0,0,0;False;3;FLOAT;3;False;1;FLOAT4;0
...
Node;AmplifyShaderEditor.FunctionNode;107;-1450.858,572.9877;Inherit;False;RadialUVDistortion;-1;;32;051d65e7699b41a4c800363fd0e822b2;0;7;60;SAMPLER2D;_Sampler60107;False;1;FLOAT2;1,1;False;11;FLOAT2;0,0;False;65;FLOAT;1;False;68;FLOAT2;0,1;False;47;FLOAT2;0,0.1;False;29;FLOAT2;0,0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.RangedFloatNode;6;-1485.776,415.8315;Float;False;Property;_WaveSpeed;WaveSpeed;0;0;Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleTimeNode;5;-1509.689,321.3844;Inherit;False;1;0;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;85;-922.9891,1419.601;Inherit;False;PosterizeSteps;-1;;28;a5af708c0f358a1409563877edfc2aac;0;2;1;FLOAT4;0,0,0,0;False;3;FLOAT;3;False;1;FLOAT4;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;22;-1423.667,11.13445;Inherit;False;20;WaveTileUV;1;0;OBJECT;0;False;1;FLOAT2;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;7;-1221.207,332.1361;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.Vector2Node;4;-1449.096,139.0983;Float;False;Property;_WaveDirection;WaveDirection;1;0;Create;True;0;0;0;False;0;False;1,0;1,0;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
Node;AmplifyShaderEditor.RangedFloatNode;113;-1083.141,441.2784;Inherit;False;Property;_2NoiseContrast;2NoiseContrast;9;0;Create;True;0;0;0;False;0;False;1;1.5;1;6;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;94;-455.1952,1391.657;Inherit;False;PosterizeSteps;-1;;33;a5af708c0f358a1409563877edfc2aac;0;2;1;FLOAT4;0,0,0,0;False;3;FLOAT;3;False;1;FLOAT4;0
Node;AmplifyShaderEditor.RangedFloatNode;115;-752.7813,674.5148;Inherit;False;Property;_2NoiseStrength;2NoiseStrength;10;0;Create;True;0;0;0;False;0;False;1;1;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.PannerNode;3;-1003.783,111.4484;Inherit;True;3;0;FLOAT2;0,0;False;2;FLOAT2;0,0;False;1;FLOAT;1;False;1;FLOAT2;0
Node;AmplifyShaderEditor.GetLocalVarNode;130;-293.5594,438.5303;Inherit;True;129;lightLerp;1;0;OBJECT;;False;1;FLOAT4;0
...
Node;AmplifyShaderEditor.NoiseGeneratorNode;2;-703.5278,60.64958;Inherit;True;Simplex3D;True;False;2;0;FLOAT3;0,0,0;False;1;FLOAT;1;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;148;-77.32281,541.5864;Inherit;False;Constant;_Float0;Float 0;12;0;Create;True;0;0;0;False;0;False;1;1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;147;137.3346,425.2467;Inherit;False;2;2;0;FLOAT4;0,0,0,0;False;1;FLOAT;1;False;1;FLOAT4;0
...
Node;AmplifyShaderEditor.RangedFloatNode;153;-126.1002,353.634;Inherit;False;Constant;_Float1;Float 1;12;0;Create;True;0;0;0;False;0;False;1;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.Vector4Node;165;114.2565,537.6131;Inherit;False;Property;_RemapValues;RemapValues;12;0;Create;True;0;0;0;False;0;False;0,1,0,1.2;0,0.6,0.6,1.2;0;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RegisterLocalVarNode;99;557.8245,1618.214;Inherit;True;light;-1;True;1;0;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.LightColorNode;163;-37.26281,-33.48122;Inherit;False;0;3;COLOR;0;FLOAT3;1;FLOAT;2
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;152;28.59979,276.9341;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;FLOAT;1;False;1;COLOR;0
Node;AmplifyShaderEditor.GetLocalVarNode;104;531.381,139.0938;Inherit;False;99;light;1;0;OBJECT;;False;1;COLOR;0
Node;AmplifyShaderEditor.BlendOpsNode;146;642.9589,398.0769;Inherit;True;HardMix;True;3;0;FLOAT4;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;FLOAT;1;False;1;COLOR;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;128;331.7737,58.06403;Inherit;True;2;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.SamplerNode;168;764.2002,-178.9301;Inherit;True;Property;_MainTexture;MainTexture;13;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ColorNode;31;845.8781,-357.0184;Inherit;False;Property;_Albedo;Albedo;5;0;Create;True;0;0;0;False;0;False;1,1,1,1;1,0.6396222,0,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.LerpOp;127;846.0188,41.74914;Inherit;True;3;0;COLOR;0,0,0,0;False;1;COLOR;1,1,1,0;False;2;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.OneMinusNode;167;395.9008,305.8277;Inherit;False;1;0;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.ColorNode;126;1095.531,-492.1125;Inherit;False;Property;_EmissionColor;EmissionColor;11;1;[HDR];Create;True;0;0;0;False;0;False;0,0,0,0;0,0,0,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ToggleSwitchNode;30;-1200.635,-987.1863;Inherit;False;Property;_AlignOnWorldX;AlignOnWorldX;4;0;Create;True;0;0;0;False;0;False;1;True;2;0;FLOAT2;0,0;False;1;FLOAT2;0,0;False;1;FLOAT2;0
...
ASEEND*/
//CHKSM=7809D3684B577C6171761E263BCB8845E2C9B01E