...
Shader "Julian/GradientSkybox3"
{
	Properties
	{
		_Vector2("Vector 1", Vector) = (500,500,0,0)
	...
	SubShader
	{
		...
		{
			Gradient gradient1 = NewGradient( 0, 5, 2, float4( 0.9, 0.07941177, 0, 0 ), float4( 0.09149998, 0.2125711, 0.61, 0.4983749 ), float4( 1, 0.7532815, 0, 0.5179217 ), float4( 1, 0.7532815, 0, 0.5624323 ), float4( 0.09019608, 0.2117647, 0.6117647, 0.5808957 ), 0, 0, 0, float2( 1, 0 ), float2( 1, 1 ), 0, 0, 0, 0, 0, 0 );
			float2 panner27 = ( 1.0 * _Time.y * _Vector2 + float2( 0,0 ));
			...
			Gradient gradient39 = NewGradient( 0, 2, 2, float4( 0.9, 0.07941177, 0, 0 ), float4( 0.09149998, 0.2125711, 0.61, 0.4983749 ), 0, 0, 0, 0, 0, 0, float2( 1, 0 ), float2( 1, 1 ), 0, 0, 0, 0, 0, 0 );
			Gradient gradient43 = NewGradient( 0, 2, 2, float4( 1, 1, 1, 0 ), float4( 0, 0, 0, 0.2877241 ), 0, 0, 0, 0, 0, 0, float2( 1, 0 ), float2( 1, 1 ), 0, 0, 0, 0, 0, 0 );
			float4 lerpResult41 = lerp( SampleGradient( gradient1, ( ( noise30 * 0.5 ) + ase_vertex3Pos.y ) ) , SampleGradient( gradient39, ase_vertex3Pos.y ) , SampleGradient( gradient43, ase_vertex3Pos.y ));
...
/*ASEBEGIN
Version=18912
7;262;1906;757;1686.016;87.54178;1.3;True;False
Node;AmplifyShaderEditor.Vector2Node;25;-1596.749,-260.5724;Inherit;False;Property;_Vector2;Vector 1;0;0;Create;True;0;0;0;False;0;False;500,500;0,-50;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
...
Node;AmplifyShaderEditor.GradientNode;1;-1127.8,116.9;Inherit;False;0;5;2;0.9,0.07941177,0,0;0.09149998,0.2125711,0.61,0.4983749;1,0.7532815,0,0.5179217;1,0.7532815,0,0.5624323;0.09019608,0.2117647,0.6117647,0.5808957;1,0;1,1;0;1;OBJECT;0
...
ASEEND*/
//CHKSM=F563662687675F42608D723E61C018BB0A4B332E