...
Shader "Julian/NoiseTerrain"
{
	Properties
	{
		...
		_CircularNoiseCenter("CircularNoiseCenter", Vector) = (0,0,0,0)
	...
	SubShader
	{
		...
		uniform half2 _CircularNoiseCenter;
		...
		inline half4 LightingStandardCustomLighting( inout SurfaceOutputCustomLightingCustom s, half3 viewDir, UnityGI gi )
		{
			...
			half2 temp_output_31_0_g36 = ( ( _CircularNoiseCenter + appendResult205 ) - float2( 1,1 ) );
...
/*ASEBEGIN
Version=18912
40;573;1906;953;2789.145;23.88566;1.321931;True;True
...
Node;AmplifyShaderEditor.WorldPosInputsNode;204;-2122.011,202.3642;Inherit;False;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
...
Node;AmplifyShaderEditor.DynamicAppendNode;205;-1888.341,238.9241;Inherit;False;FLOAT2;4;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;50;False;3;FLOAT;0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.Vector2Node;216;-2019.467,41.06778;Inherit;False;Property;_CircularNoiseCenter;CircularNoiseCenter;11;0;Create;True;0;0;0;False;0;False;0,0;0,300;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
...
Node;AmplifyShaderEditor.SimpleAddOpNode;217;-1737.467,192.0678;Inherit;False;2;2;0;FLOAT2;0,0;False;1;FLOAT2;0,0;False;1;FLOAT2;0
...
ASEEND*/
//CHKSM=E31DA3761779FE459270E59B26F624B7FE8BE249