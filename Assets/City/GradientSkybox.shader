...
Shader "Julian/GradientSkybox"
{
	...
	SubShader
	{
		...
		{
			Gradient gradient1 = NewGradient( 0, 2, 2, float4( 1, 0.5615012, 0, 0.1799954 ), float4( 0.7924528, 0, 0, 0.9000076 ), 0, 0, 0, 0, 0, 0, float2( 1, 0 ), float2( 1, 1 ), 0, 0, 0, 0, 0, 0 );
...
/*ASEBEGIN
Version=18912
80;656;1628;689;1599.74;51.50009;1;True;True
Node;AmplifyShaderEditor.PosVertexDataNode;2;-1131.2,218.9;Inherit;False;0;0;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.GradientNode;1;-1127.8,116.9;Inherit;False;0;2;2;1,0.5615012,0,0.1799954;0.7924528,0,0,0.9000076;1,0;1,1;0;1;OBJECT;0
...
ASEEND*/
//CHKSM=011C6A5E34F9C31D9F1982580D8640BFD705566E