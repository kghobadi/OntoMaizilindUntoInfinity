...
Shader "Julian/GradientSkybox2"
{
	Properties
	{
		_BottomColor("BottomColor", Color) = (1,0.5607843,0,1)
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutput o )
		{
			...
			float4 temp_cast_0 = ((_RemapValues.z + (ase_vertex3Pos.y - _RemapValues.x) * (_RemapValues.w - _RemapValues.z) / (_RemapValues.y - _RemapValues.x))).xxxx;
			float temp_output_3_0_g2 = 3.0;
			float4 temp_output_33_0 = ( trunc( ( temp_cast_0 * temp_output_3_0_g2 ) ) / temp_output_3_0_g2 );
			float4 lerpResult27 = lerp( _BottomColor , _TopColor , saturate( temp_output_33_0 ));
...
/*ASEBEGIN
Version=18912
-86;317;1906;1013;1545.45;-340.9539;1.614134;True;False
...
Node;AmplifyShaderEditor.Vector4Node;35;-1622.909,607.0806;Inherit;False;Property;_RemapValues;RemapValues;3;0;Create;True;0;0;0;False;0;False;0,1,0,1;0,0,0,1;0;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.TexturePropertyNode;51;-591.0941,768.586;Inherit;True;Property;_BackgroundTex;BackgroundTex;7;0;Create;True;0;0;0;False;0;False;None;cd7946e1eb09a2c41bc707dd4b3545fb;False;white;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
...
Node;AmplifyShaderEditor.FunctionNode;33;-1214.8,360.5433;Inherit;False;PosterizeSteps;-1;;2;a5af708c0f358a1409563877edfc2aac;0;2;1;FLOAT4;0,0,0,0;False;3;FLOAT;3;False;1;FLOAT4;0
Node;AmplifyShaderEditor.LerpOp;39;839.2059,675.6291;Inherit;True;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;FLOAT;0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.SaturateNode;30;-1024.104,499.0835;Inherit;False;1;0;FLOAT4;0,0,0,0;False;1;FLOAT4;0
...
Node;AmplifyShaderEditor.LerpOp;27;-713.1882,562.2451;Inherit;True;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;COLOR;0,0,0,0;False;1;COLOR;0
...
ASEEND*/
//CHKSM=7B35164E77167FD3FEDE420011D8C2E166B32DE9