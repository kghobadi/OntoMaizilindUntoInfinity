...
Shader "Julian/CourtyardFloor"
{
	Properties
	{
		...
		_MaskSoftness1("MaskSoftness", Range( 0 , 1)) = 0
	...
	SubShader
	{
		...
		inline half4 LightingStandardCustomLighting( inout SurfaceOutputCustomLightingCustom s, half3 viewDir, UnityGI gi )
		{
			...
			half2 temp_output_1_0_g38 = float2( 1,1 );
			half2 appendResult10_g38 = (half2(( (temp_output_1_0_g38).x * i.uv_texcoord.x ) , ( i.uv_texcoord.y * (temp_output_1_0_g38).y )));
			half2 temp_output_11_0_g38 = float2( 0,0 );
			half2 panner18_g38 = ( ( (temp_output_11_0_g38).x * _Time.y ) * float2( 1,0 ) + i.uv_texcoord);
			half2 panner19_g38 = ( ( _Time.y * (temp_output_11_0_g38).y ) * float2( 0,1 ) + i.uv_texcoord);
			half2 appendResult24_g38 = (half2((panner18_g38).x , (panner19_g38).y));
			...
			half2 temp_output_47_0_g38 = appendResult212;
			float2 uv_TexCoord78_g38 = i.uv_texcoord * float2( 2,2 );
			half2 temp_output_31_0_g38 = ( uv_TexCoord78_g38 - float2( 1,1 ) );
			half2 appendResult39_g38 = (half2(frac( ( atan2( (temp_output_31_0_g38).x , (temp_output_31_0_g38).y ) / 6.28318548202515 ) ) , length( temp_output_31_0_g38 )));
			half2 panner54_g38 = ( ( (temp_output_47_0_g38).x * _Time.y ) * float2( 1,0 ) + appendResult39_g38);
			half2 panner55_g38 = ( ( _Time.y * (temp_output_47_0_g38).y ) * float2( 0,1 ) + appendResult39_g38);
			half2 appendResult58_g38 = (half2((panner54_g38).x , (panner55_g38).y));
			half simplePerlin3D214 = snoise( half3( ( ( (tex2D( _Sampler60213, ( appendResult10_g38 + appendResult24_g38 ) )).rg * 1.0 ) + ( appendResult211 * appendResult58_g38 ) ) ,  0.0 ) );
			...
			half temp_output_97_0 = saturate( ( 1.0 - ( ( distance( _Color1.rgb , ( tex2D( _Texture1, uv_TexCoord51 ) * _Color1 ).rgb ) - lerpResult150 ) / max( _MaskSoftness1 , 1E-05 ) ) ) );
...
/*ASEBEGIN
Version=18912
7;48;1906;971;495.0858;1951.434;1;True;True
...
Node;AmplifyShaderEditor.Vector4Node;89;-1101.271,-1345.145;Inherit;False;Property;_Tex1TilingOffset;Tex1Tiling&Offset;6;0;Create;True;0;0;0;False;0;False;0.5,0.5,1,1;3.21,3.2,0,0;0;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.Vector4Node;208;-1526.339,730.723;Inherit;False;Property;_CircularNoiseTileAndSpeed;CircularNoiseTileAndSpeed;3;0;Create;True;0;0;0;False;0;False;0,10,0,0.1;15,25,0,0.03;0;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.TexturePropertyNode;61;-659.2667,-1676.458;Inherit;True;Property;_Texture1;Texture1;4;1;[NoScaleOffset];Create;True;0;0;0;False;0;False;None;b9c2fc0d19862a349892b2efa3953c18;False;white;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
...
Node;AmplifyShaderEditor.FunctionNode;213;-1049.933,631.1348;Inherit;False;RadialUVDistortion;-1;;38;051d65e7699b41a4c800363fd0e822b2;0;7;60;SAMPLER2D;_Sampler60213;False;1;FLOAT2;1,1;False;11;FLOAT2;0,0;False;65;FLOAT;1;False;68;FLOAT2;0,1;False;47;FLOAT2;0,0.1;False;29;FLOAT2;0,0;False;1;FLOAT2;0
...
Node;AmplifyShaderEditor.RangedFloatNode;103;84.4082,-1496.501;Inherit;False;Property;_MaskRange;MaskRange;10;0;Create;True;0;0;0;False;0;False;0.5;1;0.4;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;264;166.9142,-1353.434;Inherit;False;Property;_MaskSoftness1;MaskSoftness;8;0;Create;True;0;0;0;False;0;False;0;0;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;218;-682.2156,499.4255;Inherit;False;Property;_2NoiseContrast;2NoiseContrast;5;0;Create;True;0;0;0;False;0;False;1;1.5;1;6;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;215;-376.8558,768.6619;Inherit;False;Property;_2NoiseStrength;2NoiseStrength;9;0;Create;True;0;0;0;False;0;False;1;1;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;97;461.6801,-1510.629;Inherit;True;Color Mask;-1;;40;eec747d987850564c95bde0e5a6d1867;0;4;1;FLOAT3;0,0,0;False;3;FLOAT3;1,1,1;False;4;FLOAT;0.7;False;5;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;254;721.2198,916.7878;Inherit;False;253;lightIntensity;1;0;OBJECT;;False;1;COLOR;0
Node;AmplifyShaderEditor.ColorNode;207;90.03642,56.714;Inherit;False;Property;_AmbientColor;AmbientColor;14;1;[HDR];Create;True;0;0;0;False;0;False;0,0,0,0;0.6037736,0.3097896,0,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.ColorNode;202;728.09,508.527;Inherit;False;Property;_Color0;Color 0;2;0;Create;True;0;0;0;False;0;False;1,1,1,0;0.754717,0.5312355,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.ColorNode;252;744.8466,688.642;Inherit;False;Property;_BackgroundColor;BackgroundColor;15;0;Create;True;0;0;0;False;0;False;0.08677466,0.2332488,0.4716981,0;0,0.05079827,0.1320755,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SimpleAddOpNode;263;940.9082,884.0854;Inherit;True;2;2;0;COLOR;0,0,0,0;False;1;COLOR;0.3,0.3,0.3,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.LerpOp;256;1225.181,726.9868;Inherit;True;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;COLOR;0.1792453,0.1792453,0.1792453,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.FunctionNode;186;-734.852,1774.004;Inherit;False;PosterizeSteps;-1;;41;a5af708c0f358a1409563877edfc2aac;0;2;1;FLOAT4;0,0,0,0;False;3;FLOAT;3;False;1;FLOAT4;0
...
ASEEND*/
//CHKSM=8648A5437040F2E5700D1E7D99CEC5F7349FE54C