...
Shader "Julian/Courtyard"
{
	...
	SubShader
	{
		...
		inline half4 LightingStandardCustomLighting( inout SurfaceOutputCustomLightingCustom s, half3 viewDir, UnityGI gi )
		{
			...
			half temp_output_97_0 = saturate( ( 1.0 - ( ( distance( _Color1.rgb , ( ( tex2D( _Texture1, uv_TexCoord51 ) * _Color1 ) + (( _Use2Textures )?( ( tex2D( _Texture0, uv_TexCoord132 ) * _Color2 ) ):( float4( 0,0,0,0 ) )) ).rgb ) - lerpResult150 ) / max( _MaskSoftness , 1E-05 ) ) ) );
			half mainTex85 = temp_output_97_0;
			half temp_output_123_0 = ceil( mainTex85 );
			#if defined(LIGHTMAP_ON) && ( UNITY_VERSION < 560 || ( defined(LIGHTMAP_SHADOW_MIXING) && !defined(SHADOWS_SHADOWMASK) && defined(SHADOWS_SCREEN) ) )//aselc
			half4 ase_lightColor = 0;
			#else //aselc
			half4 ase_lightColor = _LightColor0;
			#endif //aselc
			half4 temp_cast_5 = (ase_lightAtten).xxxx;
			...
			half4 temp_cast_8 = (ase_lightAtten).xxxx;
			half temp_output_3_0_g22 = lightSteps171;
			half4 temp_output_26_0 = CalculateContrast(4.0,( ( trunc( ( temp_cast_7 * temp_output_3_0_g23 ) ) / temp_output_3_0_g23 ) * ( ase_lightColor.a * ( trunc( ( temp_cast_8 * temp_output_3_0_g22 ) ) / temp_output_3_0_g22 ) ) ));
			half4 lerpResult29 = lerp( ( ase_lightColor * ( trunc( ( temp_cast_5 * temp_output_3_0_g24 ) ) / temp_output_3_0_g24 ) ) , float4( 0,0,0,0 ) , saturate( ( 1.0 - temp_output_26_0 ) ));
			half4 light73 = lerpResult29;
			half4 lightIntensity213 = temp_output_26_0;
			half4 lerpResult211 = lerp( float4( 0,0,0,0 ) , _BackgroundColor , ( lightIntensity213 + float4( 0.3,0.3,0.3,0 ) ));
			half4 lerpResult205 = lerp( _AmbientColor , light73 , light73);
			half4 lerpResult212 = lerp( lerpResult211 , ( (( _UseLight )?( 1.0 ):( 0.0 )) == 0.0 ? float4( 0,0,0,0 ) : ( mainTex85 * lerpResult205 * _Color0 ) ) , temp_output_123_0);
			c.rgb = lerpResult212.rgb;
			c.a = 1;
			clip( (( _UseTransparency )?( ( temp_output_123_0 * ( (( _UseLight )?( 1.0 ):( 0.0 )) == 1.0 ? light73 : float4( 1,1,1,0 ) ) ) ):( float4( 1,0,0,0 ) )).r - _Cutoff );
			return c;
		}
...
/*ASEBEGIN
Version=18912
196;364;1906;977;578.1461;1871.435;1;True;True
...
Node;AmplifyShaderEditor.RangedFloatNode;170;-1675.505,2057.035;Inherit;False;Property;_LightSteps;LightSteps;12;0;Create;True;0;0;0;False;0;False;4;4;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.Vector4Node;126;-1082.698,-976.2512;Inherit;False;Property;_Vector0;Vector 0;13;0;Create;True;0;0;0;False;0;False;0.5,0.5,1,1;1,0,0,1;0;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.Vector4Node;89;-1101.271,-1345.145;Inherit;False;Property;_Tex1TilingOffset;Tex1Tiling&Offset;6;0;Create;True;0;0;0;False;0;False;0.5,0.5,1,1;1,1,0,0;0;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.TexturePropertyNode;131;-647.8299,-1277.575;Inherit;True;Property;_Texture0;Texture 0;15;1;[NoScaleOffset];Create;True;0;0;0;False;0;False;None;5c0d01a670cd56949954f39d01862a2d;False;white;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
...
Node;AmplifyShaderEditor.ColorNode;142;-282.0769,-922.0991;Inherit;False;Property;_Color2;Color2;4;0;Create;True;0;0;0;False;0;False;0,0,0,0;0.1,0.1,0.1,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.TexturePropertyNode;61;-659.2667,-1676.458;Inherit;True;Property;_Texture1;Texture1;5;1;[NoScaleOffset];Create;True;0;0;0;False;0;False;None;61b99d7e65e14dd469167ae1795e499f;False;white;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
...
Node;AmplifyShaderEditor.RangedFloatNode;161;-46.17177,-1815.854;Inherit;False;Property;_MaskRangeMin;MaskRangeMin;9;0;Create;True;0;0;0;False;0;False;0.4;0.67;0.1;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;103;84.4082,-1496.501;Inherit;False;Property;_MaskRange;MaskRange;8;0;Create;True;0;0;0;False;0;False;0.5;0.88;0.4;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.ToggleSwitchNode;140;107.6322,-1183.926;Inherit;False;Property;_Use2Textures;Use2Textures;11;0;Create;True;0;0;0;False;0;False;0;True;2;0;COLOR;0,0,0,0;False;1;COLOR;1,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.RangedFloatNode;214;164.8539,-1359.435;Inherit;False;Property;_MaskSoftness;MaskSoftness;7;0;Create;True;0;0;0;False;0;False;0;0;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;207;-606.4722,767.3647;Inherit;False;Property;_AmbientColor;AmbientColor;17;1;[HDR];Create;True;0;0;0;False;0;False;0,0,0,0;0.6037736,0.3097896,0,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.GetLocalVarNode;74;-416.9733,539.4863;Inherit;True;73;light;1;0;OBJECT;;False;1;COLOR;0
Node;AmplifyShaderEditor.ColorNode;202;-373.4136,329.9891;Inherit;False;Property;_Color0;Color 0;3;0;Create;True;0;0;0;False;0;False;1,1,1,0;0.754717,0.5312355,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.GetLocalVarNode;208;621.5043,973.6215;Inherit;False;213;lightIntensity;1;0;OBJECT;;False;1;COLOR;0
Node;AmplifyShaderEditor.GetLocalVarNode;86;-366.9222,81.9416;Inherit;True;85;mainTex;1;0;OBJECT;;False;1;FLOAT;0
Node;AmplifyShaderEditor.ToggleSwitchNode;114;-176.1966,-87.47457;Inherit;False;Property;_UseLight;UseLight;10;0;Create;True;0;0;0;False;0;False;1;True;2;0;FLOAT;0;False;1;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.LerpOp;205;-147.1179,732.9326;Inherit;True;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.Compare;204;133.9264,608.4238;Inherit;False;0;4;0;FLOAT;0;False;1;FLOAT;1;False;2;COLOR;0,0,0,0;False;3;COLOR;1,1,1,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.ColorNode;210;645.1312,745.4758;Inherit;False;Property;_BackgroundColor;BackgroundColor;16;0;Create;True;0;0;0;False;0;False;0.08677466,0.2332488,0.4716981,0;0,0.05079827,0.1320755,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SimpleAddOpNode;209;841.1927,940.9191;Inherit;True;2;2;0;COLOR;0,0,0,0;False;1;COLOR;0.3,0.3,0.3,0;False;1;COLOR;0
Node;AmplifyShaderEditor.CeilOpNode;123;149.2612,362.0233;Inherit;True;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;203;333.0398,377.344;Inherit;True;2;2;0;FLOAT;0;False;1;COLOR;1,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.Compare;115;202.1157,47.25757;Inherit;True;0;4;0;FLOAT;0;False;1;FLOAT;0;False;2;COLOR;0,0,0,0;False;3;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.LerpOp;211;1125.466,783.8206;Inherit;True;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;COLOR;0.1792453,0.1792453,0.1792453,0;False;1;COLOR;0
Node;AmplifyShaderEditor.LightColorNode;206;-370.2155,798.1045;Inherit;False;0;3;COLOR;0;FLOAT3;1;FLOAT;2
...
Node;AmplifyShaderEditor.ToggleSwitchNode;125;542.8671,360.2319;Inherit;False;Property;_UseTransparency;UseTransparency;14;0;Create;True;0;0;0;False;0;False;0;True;2;0;COLOR;1,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.StandardSurfaceOutputNode;0;1246.508,-9.205021;Half;False;True;-1;2;ASEMaterialInspector;0;0;CustomLighting;Julian/Courtyard;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;Back;0;False;-1;0;False;-1;False;0;False;-1;0;False;-1;False;0;Custom;0.5;True;True;0;True;Transparent;;Geometry;All;18;all;True;True;True;True;0;False;-1;False;0;False;-1;255;False;-1;255;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;False;2;15;10;25;False;0.5;True;0;0;False;-1;0;False;-1;0;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;0.05;0,0,0,0;VertexOffset;True;False;Cylindrical;False;Relative;0;;0;-1;-1;-1;0;False;0;0;False;-1;-1;0;False;-1;0;0;0;False;0.1;False;-1;0;False;-1;False;15;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;2;FLOAT3;0,0,0;False;3;FLOAT3;0,0,0;False;4;FLOAT;0;False;6;FLOAT3;0,0,0;False;7;FLOAT3;0,0,0;False;8;FLOAT;0;False;9;FLOAT;0;False;10;FLOAT;0;False;13;FLOAT3;0,0,0;False;11;FLOAT3;0,0,0;False;12;FLOAT3;0,0,0;False;14;FLOAT4;0,0,0,0;False;15;FLOAT3;0,0,0;False;0
...
ASEEND*/
//CHKSM=828F6B8C9CB1933458D0FFDD0BD968C71C8E72AC