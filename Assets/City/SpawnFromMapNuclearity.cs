...
public class SpawnFromMapNuclearity : MonoBehaviour
{
    ...
    public List<GameObject> buildingsObj;
    ...
    void RotateBuildings()
    {
        ...
        for (int i = 0; i < buildingsObj.Count; i++)
        { 
            newRot = new Vector3(Random.Range(-12, 12), Random.Range(-4f, 4f), Random.Range(-12, 12));
            buildingsObj[i].transform.localEulerAngles = newRot;
            buildingsObj[i].transform.localPosition = new Vector3(buildingsObj[i].transform.localPosition.x, buildingsObj[i].transform.localPosition.y - Random.Range(1, 5), buildingsObj[i].transform.localPosition.z);
        }

        for (int i = 0; i < interiorsObj.Count; i++)
        {
            newRot = new Vector3(Random.Range(-12, 12), Random.Range(-4f, 4f), Random.Range(-12, 12));
            interiorsObj[i].transform.localEulerAngles = newRot;
            interiorsObj[i].transform.localPosition = new Vector3(interiorsObj[i].transform.localPosition.x, interiorsObj[i].transform.localPosition.y - Random.Range(1, 5), interiorsObj[i].transform.localPosition.z);
        }
    }
