...
// Light Light
uniform float4 Light_1565117884PosAndRange;
uniform float4 Light_1565117884ColorAndIntensity;
uniform float3 Light_1565117884Direction;
uniform float Light_1565117884Penumbra;
uniform int Light_1565117884ShadowSteps;

// UNIFORMS AND FUNCTIONS
uniform float x_1565117915_1d59cc68_freq;
uniform float x_1565117915_1d59cc68_intensity;
uniform float x_1565117915_1d59cc68_speed;
...
uniform float4x4 _1565117915Matrix;
uniform float4x4 _1565117915InverseMatrix;
uniform float3 x_1565117913_80f5e9c6_boxsize;
uniform int x_1565117913_80f5e9c6_steps;
uniform float x_1565117913_80f5e9c6_mult;
uniform float x_1565117913_80f5e9c6_mult2;
uniform float x_1565117913_80f5e9c6_modf;
uniform float2 x_1565117913_80f5e9c6_twist;
...
uniform float4x4 _1565117913Matrix;
uniform float _1565117913MinScale;
uniform float4 x_1565117913_da843a44_color;
...
float3 MaterialFunc(float nf, inout float3 normal, float3 p, float3 rayDir, out float objectID)
{
    ...
    [branch] if (nf <= 1) {
    //    objectID = 1;
        return material_SimpleColor(normal, objPos(_1565117913Matrix, p), rayDir, x_1565117913_da843a44_color);
    }
        objectID = 0;
...
{
    float3 p_1565117915 = objPos(_1565117915InverseMatrix, modifier_Displacement(objPos(_1565117915Matrix, p), x_1565117915_1d59cc68_freq, x_1565117915_1d59cc68_intensity, x_1565117915_1d59cc68_speed));
    float _1565117913Distance = object_FractalMenger(objPos(_1565117913Matrix, p_1565117915), x_1565117913_80f5e9c6_boxsize, x_1565117913_80f5e9c6_steps, x_1565117913_80f5e9c6_mult, x_1565117913_80f5e9c6_mult2, x_1565117913_80f5e9c6_modf, x_1565117913_80f5e9c6_twist) * _1565117913MinScale;
    result = float2(_1565117913Distance, /*material ID*/0.5);
    }
	return result;
}
...
{
LightInfo light;
light.posAndRange = Light_1565117884PosAndRange;
light.colorAndIntensity = Light_1565117884ColorAndIntensity;
