...
// Light Main Light
uniform float4 MainLight_1565093923PosAndRange;
uniform float4 MainLight_1565093923ColorAndIntensity;
uniform float3 MainLight_1565093923Direction;
uniform float MainLight_1565093923Penumbra;
uniform int MainLight_1565093923ShadowSteps;
// Light Fill Light
uniform float4 FillLight_1565093886PosAndRange;
uniform float4 FillLight_1565093886ColorAndIntensity;
uniform float3 FillLight_1565093886Direction;
uniform float FillLight_1565093886Penumbra;
uniform int FillLight_1565093886ShadowSteps;

// UNIFORMS AND FUNCTIONS
uniform float x_1565093857_6492bb9b_radius;
...
uniform float x_1565093917_ce8993a9_x;
uniform float x_1565093917_ce8993a9_y;
uniform float x_1565093917_ce8993a9_z;
uniform float x_1565093824_ce8993a9_x;
uniform float x_1565093824_ce8993a9_y;
uniform float x_1565093824_ce8993a9_z;
...
uniform float x_1565093830_6d32737e_height;
uniform float x_1565093830_6d32737e_width;
float object_HexPrism(float3 p , float _INP_height, float _INP_width) {
    // Generated from Assets/Imported/Raymarching Toolkit/Assets/Snippets/Objects/HexPrism.asset
    float3 q = abs(p);
    
    return max(q.z-_INP_height,max((q.x*0.866025+q.y*0.5),q.y)-_INP_width);
}
// uniforms for Sphere
uniform float4x4 _1565093857Matrix;
uniform float _1565093857MinScale;
// uniforms for Box
uniform float4x4 _1565093917Matrix;
uniform float _1565093917MinScale;
// uniforms for HexPrism
uniform float4x4 _1565093830Matrix;
uniform float _1565093830MinScale;
// uniforms for bg box
uniform float4x4 _1565093824Matrix;
uniform float _1565093824MinScale;
uniform float x_1565093022_131749b2_whichObject;
uniform float x_1565093119_131749b2_whichObject;
...
uniform float4 x_1565093857_da843a44_color;
uniform float4 x_1565093917_da843a44_color;
uniform float4 x_1565093830_da843a44_color;
...
uniform float2 x_1565093824_07ee3232_position;
uniform sampler2D x_1565093824_07ee3232_gradient;
...
float3 MaterialFunc(float nf, inout float3 normal, float3 p, float3 rayDir, out float objectID)
{
    ...
    [branch] if (nf <= 1) {
    //    objectID = 0.25;
        return material_SimpleColor(normal, objPos(_1565093857Matrix, p), rayDir, x_1565093857_da843a44_color);
    }
    else if(nf <= 2) {
    //    objectID = 0.5;
        return material_SimpleColor(normal, objPos(_1565093917Matrix, p), rayDir, x_1565093917_da843a44_color);
    }
    else if(nf <= 3) {
    //    objectID = 0.75;
        return material_SimpleColor(normal, objPos(_1565093830Matrix, p), rayDir, x_1565093830_da843a44_color);
    }
    else if(nf <= 4) {
    //    objectID = 1;
        return material_Gradient(normal, objPos(_1565093824Matrix, p), rayDir, x_1565093824_07ee3232_position, x_1565093824_07ee3232_gradient);
    }
        objectID = 0;
...
{
    float _1565093857Distance = object_Sphere(objPos(_1565093857Matrix, p), x_1565093857_6492bb9b_radius) * _1565093857MinScale;
    float _1565093917Distance = object_Box(objPos(_1565093917Matrix, p), x_1565093917_ce8993a9_x, x_1565093917_ce8993a9_y, x_1565093917_ce8993a9_z) * _1565093917MinScale;
    float _1565093830Distance = object_HexPrism(objPos(_1565093830Matrix, p), x_1565093830_6d32737e_height, x_1565093830_6d32737e_width) * _1565093830MinScale;
    float _1565093824Distance = object_Box(objPos(_1565093824Matrix, p), x_1565093824_ce8993a9_x, x_1565093824_ce8993a9_y, x_1565093824_ce8993a9_z) * _1565093824MinScale;
    result = opU(blend_Morph(blend_Morph(float2(_1565093857Distance, /*material ID*/0.5), float2(_1565093917Distance, /*material ID*/1.5), x_1565093119_131749b2_whichObject), float2(_1565093830Distance, /*material ID*/2.5), x_1565093022_131749b2_whichObject), float2(_1565093824Distance, /*material ID*/3.5));
    }
	return result;
}
...
{
LightInfo light;
light.posAndRange = MainLight_1565093923PosAndRange;
light.colorAndIntensity = MainLight_1565093923ColorAndIntensity;
light.direction = MainLight_1565093923Direction;
lightValue += getDirectionalLight(input, light)* softshadow(input.pos, -light.direction, INFINITY, MainLight_1565093923Penumbra, MainLight_1565093923ShadowSteps);
}
{
LightInfo light;
light.posAndRange = FillLight_1565093886PosAndRange;
light.colorAndIntensity = FillLight_1565093886ColorAndIntensity;
light.direction = FillLight_1565093886Direction;
