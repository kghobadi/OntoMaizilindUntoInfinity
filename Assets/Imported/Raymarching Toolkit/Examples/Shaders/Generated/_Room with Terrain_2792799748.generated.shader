...
// Light Sun
uniform float4 Sun_48761909PosAndRange;
uniform float4 Sun_48761909ColorAndIntensity;
uniform float3 Sun_48761909Direction;
uniform float Sun_48761909Penumbra;
uniform int Sun_48761909ShadowSteps;
// Light Light
uniform float4 Light_48762740PosAndRange;
uniform float4 Light_48762740ColorAndIntensity;
uniform float3 Light_48762740Direction;
uniform float Light_48762740Penumbra;
uniform int Light_48762740ShadowSteps;

// UNIFORMS AND FUNCTIONS
uniform float x_48762684_887f1ab6_MirrorX;
uniform float x_48762684_887f1ab6_MirrorY;
uniform float x_48762684_887f1ab6_MirrorZ;
uniform float4x4 x_48762684_887f1ab6_pivot;
uniform float x_48762684_887f1ab6_invert;
uniform float x_48762895_887f1ab6_MirrorX;
uniform float x_48762895_887f1ab6_MirrorY;
uniform float x_48762895_887f1ab6_MirrorZ;
uniform float4x4 x_48762895_887f1ab6_pivot;
uniform float x_48762895_887f1ab6_invert;
...
uniform float4x4 _48762684Matrix;
uniform float4x4 _48762684InverseMatrix;
uniform float4x4 _48762895Matrix;
uniform float4x4 _48762895InverseMatrix;
uniform float3 x_48763674_86f1660c_offset;
uniform float x_48763674_86f1660c_angle;
uniform float3 x_48763674_86f1660c_axis;
...
uniform float4x4 _48763674Matrix;
uniform float4x4 _48763674InverseMatrix;
uniform float x_48762802_8794b49b_height;
uniform float x_48762802_8794b49b_frequency;
uniform float2 x_48762802_8794b49b_clamp;
uniform float x_48762802_8794b49b_offset;
...
uniform float4x4 _48762802Matrix;
uniform float4x4 _48762802InverseMatrix;
uniform float x_48763643_b1d37f19_height;
uniform float x_48763643_b1d37f19_radius;
...
uniform float x_48763637_399aefe0_radius;
uniform float x_48763637_399aefe0_height;
uniform float x_48761967_399aefe0_radius;
uniform float x_48761967_399aefe0_height;
uniform float x_48762959_399aefe0_radius;
uniform float x_48762959_399aefe0_height;
uniform float x_48763672_399aefe0_radius;
uniform float x_48763672_399aefe0_height;
uniform float x_48762932_399aefe0_radius;
uniform float x_48762932_399aefe0_height;
...
uniform float x_48762868_6492bb9b_radius;
uniform float x_48761998_6492bb9b_radius;
...
uniform float x_48763701_ce8993a9_x;
uniform float x_48763701_ce8993a9_y;
uniform float x_48763701_ce8993a9_z;
uniform float x_48762676_ce8993a9_x;
uniform float x_48762676_ce8993a9_y;
uniform float x_48762676_ce8993a9_z;
uniform float x_48761940_ce8993a9_x;
uniform float x_48761940_ce8993a9_y;
uniform float x_48761940_ce8993a9_z;
...
uniform float4x4 _48763643Matrix;
uniform float _48763643MinScale;
// uniforms for Roof Cylinder (Subtract)
uniform float4x4 _48763637Matrix;
uniform float _48763637MinScale;
// uniforms for Window Cylinder (Subtract) (1)
uniform float4x4 _48761967Matrix;
uniform float _48761967MinScale;
// uniforms for Window Cylinder (Subtract) 
uniform float4x4 _48762959Matrix;
uniform float _48762959MinScale;
// uniforms for Sphere (Subtract)
uniform float4x4 _48762868Matrix;
uniform float _48762868MinScale;
// uniforms for Box (Subtract) (1)
uniform float4x4 _48763701Matrix;
uniform float _48763701MinScale;
// uniforms for Box (Subtract)
uniform float4x4 _48762676Matrix;
uniform float _48762676MinScale;
// uniforms for Box
uniform float4x4 _48761940Matrix;
uniform float _48761940MinScale;
// uniforms for Sphere
uniform float4x4 _48761998Matrix;
uniform float _48761998MinScale;
// uniforms for Column
uniform float4x4 _48763672Matrix;
uniform float _48763672MinScale;
// uniforms for Cylinder
uniform float4x4 _48762932Matrix;
uniform float _48762932MinScale;
// uniforms for InfinitePlane
uniform float4x4 _48762804Matrix;
uniform float _48762804MinScale;
uniform int x_48762680_d6c1f870_steps;
uniform float x_48762680_d6c1f870_intensity;
float2 blend_Stairs(float2 a, float2 b , int _INP_steps, float _INP_intensity) {
    // Generated from Assets/Raymarching Toolkit/Assets/Snippets/Blends/Stairs.asset
    float n = _INP_steps;
...
uniform float4 x_48763643_da843a44_color;
uniform float4 x_48763637_da843a44_color;
uniform float4 x_48761967_da843a44_color;
uniform float4 x_48762959_da843a44_color;
uniform float4 x_48762868_da843a44_color;
uniform float4 x_48763701_da843a44_color;
uniform float4 x_48762676_da843a44_color;
uniform float4 x_48761940_da843a44_color;
uniform float4 x_48761998_da843a44_color;
uniform float4 x_48763672_da843a44_color;
uniform float4 x_48762932_da843a44_color;
...
uniform float4 x_48762804_8abb66bb_col1;
uniform float4 x_48762804_8abb66bb_col2;
uniform float x_48762804_8abb66bb_size;
...
float3 MaterialFunc(float nf, inout float3 normal, float3 p, float3 rayDir, out float objectID)
{
    ...
    [branch] if (nf <= 1) {
    //    objectID = 0.08333334;
        return material_SimpleColor(normal, objPos(_48763643Matrix, p), rayDir, x_48763643_da843a44_color);
    }
    else if(nf <= 2) {
    //    objectID = 0.1666667;
        return material_SimpleColor(normal, objPos(_48763637Matrix, p), rayDir, x_48763637_da843a44_color);
    }
    else if(nf <= 3) {
    //    objectID = 0.25;
        return material_SimpleColor(normal, objPos(_48761967Matrix, p), rayDir, x_48761967_da843a44_color);
    }
    else if(nf <= 4) {
    //    objectID = 0.3333333;
        return material_SimpleColor(normal, objPos(_48762959Matrix, p), rayDir, x_48762959_da843a44_color);
    }
    else if(nf <= 5) {
    //    objectID = 0.4166667;
        return material_SimpleColor(normal, objPos(_48762868Matrix, p), rayDir, x_48762868_da843a44_color);
    }
    else if(nf <= 6) {
    //    objectID = 0.5;
        return material_SimpleColor(normal, objPos(_48763701Matrix, p), rayDir, x_48763701_da843a44_color);
    }
    else if(nf <= 7) {
    //    objectID = 0.5833333;
        return material_SimpleColor(normal, objPos(_48762676Matrix, p), rayDir, x_48762676_da843a44_color);
    }
    else if(nf <= 8) {
    //    objectID = 0.6666667;
        return material_SimpleColor(normal, objPos(_48761940Matrix, p), rayDir, x_48761940_da843a44_color);
    }
    else if(nf <= 9) {
    //    objectID = 0.75;
        return material_SimpleColor(normal, objPos(_48761998Matrix, p), rayDir, x_48761998_da843a44_color);
    }
    else if(nf <= 10) {
    //    objectID = 0.8333333;
        return material_SimpleColor(normal, objPos(_48763672Matrix, p), rayDir, x_48763672_da843a44_color);
    }
    else if(nf <= 11) {
    //    objectID = 0.9166667;
        return material_SimpleColor(normal, objPos(_48762932Matrix, p), rayDir, x_48762932_da843a44_color);
    }
    else if(nf <= 12) {
    //    objectID = 1;
        return material_Checkerboard(normal, objPos(_48762804Matrix, p), rayDir, x_48762804_8abb66bb_col1, x_48762804_8abb66bb_col2, x_48762804_8abb66bb_size);
    }
        objectID = 0;
...
{
    float _48763643Distance = object_Capsule(objPos(_48763643Matrix, p), x_48763643_b1d37f19_height, x_48763643_b1d37f19_radius) * _48763643MinScale;
    float3 p_48762684 = modifier_Mirror(p, x_48762684_887f1ab6_MirrorX, x_48762684_887f1ab6_MirrorY, x_48762684_887f1ab6_MirrorZ, x_48762684_887f1ab6_pivot, x_48762684_887f1ab6_invert);
    float _48763637Distance = object_Cylinder(objPos(_48763637Matrix, p_48762684), x_48763637_399aefe0_radius, x_48763637_399aefe0_height) * _48763637MinScale;
    float _48761967Distance = object_Cylinder(objPos(_48761967Matrix, p_48762684), x_48761967_399aefe0_radius, x_48761967_399aefe0_height) * _48761967MinScale;
    float _48762959Distance = object_Cylinder(objPos(_48762959Matrix, p_48762684), x_48762959_399aefe0_radius, x_48762959_399aefe0_height) * _48762959MinScale;
    float _48762868Distance = object_Sphere(objPos(_48762868Matrix, p_48762684), x_48762868_6492bb9b_radius) * _48762868MinScale;
    float _48763701Distance = object_Box(objPos(_48763701Matrix, p_48762684), x_48763701_ce8993a9_x, x_48763701_ce8993a9_y, x_48763701_ce8993a9_z) * _48763701MinScale;
    float _48762676Distance = object_Box(objPos(_48762676Matrix, p_48762684), x_48762676_ce8993a9_x, x_48762676_ce8993a9_y, x_48762676_ce8993a9_z) * _48762676MinScale;
    float _48761940Distance = object_Box(objPos(_48761940Matrix, p_48762684), x_48761940_ce8993a9_x, x_48761940_ce8993a9_y, x_48761940_ce8993a9_z) * _48761940MinScale;
    float _48761998Distance = object_Sphere(objPos(_48761998Matrix, p_48762684), x_48761998_6492bb9b_radius) * _48761998MinScale;
    float3 p_48762895 = modifier_Mirror(p_48762684, x_48762895_887f1ab6_MirrorX, x_48762895_887f1ab6_MirrorY, x_48762895_887f1ab6_MirrorZ, x_48762895_887f1ab6_pivot, x_48762895_887f1ab6_invert);
    float3 p_48763674 = objPos(_48763674InverseMatrix, modifier_Twist(objPos(_48763674Matrix, p_48762895), x_48763674_86f1660c_offset, x_48763674_86f1660c_angle, x_48763674_86f1660c_axis));
    float _48763672Distance = object_Cylinder(objPos(_48763672Matrix, p_48763674), x_48763672_399aefe0_radius, x_48763672_399aefe0_height) * _48763672MinScale;
    float _48762932Distance = object_Cylinder(objPos(_48762932Matrix, p_48762895), x_48762932_399aefe0_radius, x_48762932_399aefe0_height) * _48762932MinScale;
    float3 p_48762802 = objPos(_48762802InverseMatrix, modifier_ExampleYDisplacement(objPos(_48762802Matrix, p), x_48762802_8794b49b_height, x_48762802_8794b49b_frequency, x_48762802_8794b49b_clamp, x_48762802_8794b49b_offset));
    float _48762804Distance = object_InfinitePlane(objPos(_48762804Matrix, p_48762802)) * _48762804MinScale;
    result = opU(opU(float2(_48763643Distance, /*material ID*/0.5), blend_Stairs(opSubtract(float2(_48763637Distance, /*material ID*/1.5), opSubtract(float2(_48761967Distance, /*material ID*/2.5), opSubtract(float2(_48762959Distance, /*material ID*/3.5), opSubtract(float2(_48762868Distance, /*material ID*/4.5), opSubtract(float2(_48763701Distance, /*material ID*/5.5), opSubtract(float2(_48762676Distance, /*material ID*/6.5), opU(float2(_48761940Distance, /*material ID*/7.5), float2(_48761998Distance, /*material ID*/8.5)))))))), opU(float2(_48763672Distance, /*material ID*/9.5), float2(_48762932Distance, /*material ID*/10.5)), x_48762680_d6c1f870_steps, x_48762680_d6c1f870_intensity)), float2(_48762804Distance, /*material ID*/11.5));
    }
	return result;
}
...
{
LightInfo light;
light.posAndRange = Sun_48761909PosAndRange;
light.colorAndIntensity = Sun_48761909ColorAndIntensity;
light.direction = Sun_48761909Direction;
lightValue += getDirectionalLight(input, light)* softshadow(input.pos, -light.direction, INFINITY, Sun_48761909Penumbra, Sun_48761909ShadowSteps);
}
{
LightInfo light;
light.posAndRange = Light_48762740PosAndRange;
light.colorAndIntensity = Light_48762740ColorAndIntensity;
lightValue += getPointLight(input, light)* softshadow(input.pos, normalize(Light_48762740PosAndRange.xyz - input.pos), length(Light_48762740PosAndRange.xyz - input.pos), Light_48762740Penumbra, Light_48762740ShadowSteps);
}
	return lightValue;
}
