...
// Light Key Light
uniform float4 KeyLight_1565095847PosAndRange;
uniform float4 KeyLight_1565095847ColorAndIntensity;
uniform float3 KeyLight_1565095847Direction;
uniform float KeyLight_1565095847Penumbra;
uniform int KeyLight_1565095847ShadowSteps;
// Light Fill Light
uniform float4 FillLight_1565096769PosAndRange;
uniform float4 FillLight_1565096769ColorAndIntensity;
uniform float3 FillLight_1565096769Direction;
uniform float FillLight_1565096769Penumbra;
uniform int FillLight_1565096769ShadowSteps;
// Light Rim Light
uniform float4 RimLight_1565118876PosAndRange;
uniform float4 RimLight_1565118876ColorAndIntensity;
uniform float3 RimLight_1565118876Direction;
uniform float RimLight_1565118876Penumbra;
uniform int RimLight_1565118876ShadowSteps;

// UNIFORMS AND FUNCTIONS
uniform float x_1565094018_78743491_repetitions;
uniform float x_1565094018_78743491_offset;
uniform float4x4 x_1565094018_78743491_pivot;
float3 modifier_RadialSymmetry(float3 p , float _INP_repetitions, float _INP_offset, float4x4 _INP_pivot) {
    // Generated from Assets/Imported/Raymarching Toolkit/Assets/Snippets/Modifiers/RadialSymmetry.asset
...
uniform float4x4 _1565094018Matrix;
uniform float4x4 _1565094018InverseMatrix;
uniform float x_1565119961_887f1ab6_MirrorX;
uniform float x_1565119961_887f1ab6_MirrorY;
uniform float x_1565119961_887f1ab6_MirrorZ;
uniform float4x4 x_1565119961_887f1ab6_pivot;
uniform float x_1565119961_887f1ab6_invert;
...
uniform float4x4 _1565119961Matrix;
uniform float4x4 _1565119961InverseMatrix;
uniform float3 x_1565094975_86f1660c_offset;
uniform float x_1565094975_86f1660c_angle;
uniform float3 x_1565094975_86f1660c_axis;
...
uniform float4x4 _1565094975Matrix;
uniform float4x4 _1565094975InverseMatrix;
uniform float3 x_1565094979_b2cbb042_size;
uniform float x_1565094979_b2cbb042_roundedness;
...
uniform float x_1565118818_6492bb9b_radius;
uniform float x_1565120889_6492bb9b_radius;
...
uniform float x_1565121732_eabc26f4_radius;
uniform float x_1565121732_eabc26f4_thickness;
uniform float x_1565121732_eabc26f4_frequency;
uniform float x_1565121732_eabc26f4_displacement;
float object_Torus(float3 p , float _INP_radius, float _INP_thickness, float _INP_frequency, float _INP_displacement) {
    // Generated from Assets/Imported/Raymarching Toolkit/Assets/Snippets/Objects/Torus.asset
...
uniform float4x4 _1565094979Matrix;
uniform float _1565094979MinScale;
// uniforms for Sphere
uniform float4x4 _1565118818Matrix;
uniform float _1565118818MinScale;
// uniforms for Sphere
uniform float4x4 _1565120889Matrix;
uniform float _1565120889MinScale;
// uniforms for Torus
uniform float4x4 _1565121732Matrix;
uniform float _1565121732MinScale;
uniform int x_1565118099_d6c1f870_steps;
uniform float x_1565118099_d6c1f870_intensity;
...
uniform float4 x_1565094979_da843a44_color;
uniform float4 x_1565118818_da843a44_color;
uniform float4 x_1565120889_da843a44_color;
uniform float4 x_1565121732_da843a44_color;
...
float3 MaterialFunc(float nf, inout float3 normal, float3 p, float3 rayDir, out float objectID)
{
    ...
    [branch] if (nf <= 1) {
    //    objectID = 0.25;
        return material_SimpleColor(normal, objPos(_1565094979Matrix, p), rayDir, x_1565094979_da843a44_color);
    }
    else if(nf <= 2) {
    //    objectID = 0.5;
        return material_SimpleColor(normal, objPos(_1565118818Matrix, p), rayDir, x_1565118818_da843a44_color);
    }
    else if(nf <= 3) {
    //    objectID = 0.75;
        return material_SimpleColor(normal, objPos(_1565120889Matrix, p), rayDir, x_1565120889_da843a44_color);
    }
    else if(nf <= 4) {
    //    objectID = 1;
        return material_SimpleColor(normal, objPos(_1565121732Matrix, p), rayDir, x_1565121732_da843a44_color);
    }
        objectID = 0;
...
{
    float3 p_1565094018 = objPos(_1565094018InverseMatrix, modifier_RadialSymmetry(objPos(_1565094018Matrix, p), x_1565094018_78743491_repetitions, x_1565094018_78743491_offset, x_1565094018_78743491_pivot));
    float3 p_1565119961 = modifier_Mirror(p_1565094018, x_1565119961_887f1ab6_MirrorX, x_1565119961_887f1ab6_MirrorY, x_1565119961_887f1ab6_MirrorZ, x_1565119961_887f1ab6_pivot, x_1565119961_887f1ab6_invert);
    float3 p_1565094975 = objPos(_1565094975InverseMatrix, modifier_Twist(objPos(_1565094975Matrix, p_1565119961), x_1565094975_86f1660c_offset, x_1565094975_86f1660c_angle, x_1565094975_86f1660c_axis));
    float _1565094979Distance = object_RoundedBox(objPos(_1565094979Matrix, p_1565094975), x_1565094979_b2cbb042_size, x_1565094979_b2cbb042_roundedness) * _1565094979MinScale;
    float _1565118818Distance = object_Sphere(objPos(_1565118818Matrix, p_1565119961), x_1565118818_6492bb9b_radius) * _1565118818MinScale;
    float _1565120889Distance = object_Sphere(objPos(_1565120889Matrix, p_1565119961), x_1565120889_6492bb9b_radius) * _1565120889MinScale;
    float _1565121732Distance = object_Torus(objPos(_1565121732Matrix, p_1565119961), x_1565121732_eabc26f4_radius, x_1565121732_eabc26f4_thickness, x_1565121732_eabc26f4_frequency, x_1565121732_eabc26f4_displacement) * _1565121732MinScale;
    result = blend_Stairs(blend_Stairs(float2(_1565094979Distance, /*material ID*/0.5), opSubtract(float2(_1565118818Distance, /*material ID*/1.5), float2(_1565120889Distance, /*material ID*/2.5)), x_1565118099_d6c1f870_steps, x_1565118099_d6c1f870_intensity), float2(_1565121732Distance, /*material ID*/3.5), x_1565118099_d6c1f870_steps, x_1565118099_d6c1f870_intensity);
    }
	return result;
}
...
{
LightInfo light;
light.posAndRange = KeyLight_1565095847PosAndRange;
light.colorAndIntensity = KeyLight_1565095847ColorAndIntensity;
light.direction = KeyLight_1565095847Direction;
lightValue += getDirectionalLight(input, light)* softshadow(input.pos, -light.direction, INFINITY, KeyLight_1565095847Penumbra, KeyLight_1565095847ShadowSteps);
}
{
LightInfo light;
light.posAndRange = FillLight_1565096769PosAndRange;
light.colorAndIntensity = FillLight_1565096769ColorAndIntensity;
light.direction = FillLight_1565096769Direction;
lightValue += getDirectionalLight(input, light)* softshadow(input.pos, -light.direction, INFINITY, FillLight_1565096769Penumbra, FillLight_1565096769ShadowSteps);
}
{
LightInfo light;
light.posAndRange = RimLight_1565118876PosAndRange;
light.colorAndIntensity = RimLight_1565118876ColorAndIntensity;
light.direction = RimLight_1565118876Direction;
lightValue += getDirectionalLight(input, light)* softshadow(input.pos, -light.direction, INFINITY, RimLight_1565118876Penumbra, RimLight_1565118876ShadowSteps);
}
	return lightValue;
}
