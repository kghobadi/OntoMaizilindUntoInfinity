/*
  ...
  Imported\Raymarching Toolkit\Examples\Assets\Museum\RaymarchTemplateNoZ.shader
...
uniform float4 Directionallight23_1565096835PosAndRange;
uniform float4 Directionallight23_1565096835ColorAndIntensity;
uniform float3 Directionallight23_1565096835Direction;
uniform float Directionallight23_1565096835Penumbra;
uniform int Directionallight23_1565096835ShadowSteps;

// UNIFORMS AND FUNCTIONS
uniform float x_1565095752_6492bb9b_radius;
...
uniform float x_1565095779_ce8993a9_x;
uniform float x_1565095779_ce8993a9_y;
uniform float x_1565095779_ce8993a9_z;
...
uniform float3 x_1565095878_80f5e9c6_boxsize;
uniform int x_1565095878_80f5e9c6_steps;
uniform float x_1565095878_80f5e9c6_mult;
uniform float x_1565095878_80f5e9c6_mult2;
uniform float x_1565095878_80f5e9c6_modf;
uniform float2 x_1565095878_80f5e9c6_twist;
...
uniform float4x4 _1565095752Matrix;
uniform float _1565095752MinScale;
// uniforms for Box
uniform float4x4 _1565095779Matrix;
uniform float _1565095779MinScale;
// uniforms for FractalMenger
uniform float4x4 _1565095878Matrix;
uniform float _1565095878MinScale;
uniform float4 x_1565095752_da843a44_color;
uniform float4 x_1565095779_da843a44_color;
uniform float4 x_1565095878_da843a44_color;
...
float3 MaterialFunc(float nf, inout float3 normal, float3 p, float3 rayDir, out float objectID)
{
    ...
    [branch] if (nf <= 1) {
    //    objectID = 0.3333333;
        return material_SimpleColor(normal, objPos(_1565095752Matrix, p), rayDir, x_1565095752_da843a44_color);
    }
    else if(nf <= 2) {
    //    objectID = 0.6666667;
        return material_SimpleColor(normal, objPos(_1565095779Matrix, p), rayDir, x_1565095779_da843a44_color);
    }
    else if(nf <= 3) {
    //    objectID = 1;
        return material_SimpleColor(normal, objPos(_1565095878Matrix, p), rayDir, x_1565095878_da843a44_color);
    }
        objectID = 0;
...
{
    float _1565095752Distance = object_Sphere(objPos(_1565095752Matrix, p), x_1565095752_6492bb9b_radius) * _1565095752MinScale;
    float _1565095779Distance = object_Box(objPos(_1565095779Matrix, p), x_1565095779_ce8993a9_x, x_1565095779_ce8993a9_y, x_1565095779_ce8993a9_z) * _1565095779MinScale;
    float _1565095878Distance = object_FractalMenger(objPos(_1565095878Matrix, p), x_1565095878_80f5e9c6_boxsize, x_1565095878_80f5e9c6_steps, x_1565095878_80f5e9c6_mult, x_1565095878_80f5e9c6_mult2, x_1565095878_80f5e9c6_modf, x_1565095878_80f5e9c6_twist) * _1565095878MinScale;
    result = opSubtract(float2(_1565095752Distance, /*material ID*/0.5), opSubtract(float2(_1565095779Distance, /*material ID*/1.5), float2(_1565095878Distance, /*material ID*/2.5)));
    }
	return result;
}
...
{
LightInfo light;
light.posAndRange = Directionallight23_1565096835PosAndRange;
light.colorAndIntensity = Directionallight23_1565096835ColorAndIntensity;
lightValue += getPointLight(input, light)* hardshadow(input.pos, normalize(Directionallight23_1565096835PosAndRange.xyz - input.pos), length(Directionallight23_1565096835PosAndRange.xyz - input.pos), Directionallight23_1565096835ShadowSteps);
}
	return lightValue;
}
