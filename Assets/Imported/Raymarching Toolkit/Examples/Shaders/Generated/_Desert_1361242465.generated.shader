...
// Light light
uniform float4 light_48847405PosAndRange;
uniform float4 light_48847405ColorAndIntensity;
uniform float3 light_48847405Direction;
uniform float light_48847405Penumbra;
uniform int light_48847405ShadowSteps;
// Light light (2)
uniform float4 light2_48847345PosAndRange;
uniform float4 light2_48847345ColorAndIntensity;
uniform float3 light2_48847345Direction;
uniform float light2_48847345Penumbra;
uniform int light2_48847345ShadowSteps;

// UNIFORMS AND FUNCTIONS
uniform float x_48847308_6492bb9b_radius;
...
uniform float2 x_48847312_1ec48586_freq;
uniform float2 x_48847312_1ec48586_extranoise;
...
// uniforms for Sphere
uniform float4x4 _48847308Matrix;
uniform float _48847308MinScale;
// uniforms for Terrain
uniform float4x4 _48847312Matrix;
uniform float _48847312MinScale;
uniform float4 x_48847308_da843a44_color;
...
uniform sampler2D x_48847312_3f06f9be_textureMap;
uniform float x_48847312_3f06f9be_textureMapSize;
uniform sampler2D x_48847312_3f06f9be_bumpmap;
uniform float x_48847312_3f06f9be_bumpfactor;
uniform float x_48847312_3f06f9be_bumpmapsize;
uniform float4 x_48847312_3f06f9be_color;
uniform float x_48847312_3f06f9be_angle;
uniform float2 x_48847312_3f06f9be_flatnessmask1;
uniform float2 x_48847312_3f06f9be_flatnessmask2;
...
float3 MaterialFunc(float nf, inout float3 normal, float3 p, float3 rayDir, out float objectID)
{
    ...
    [branch] if (nf <= 1) {
    //    objectID = 0.5;
        return material_SimpleColor(normal, objPos(_48847308Matrix, p), rayDir, x_48847308_da843a44_color);
    }
    else if(nf <= 2) {
    //    objectID = 1;
        return material_DesertMaterial(normal, objPos(_48847312Matrix, p), rayDir, x_48847312_3f06f9be_textureMap, x_48847312_3f06f9be_textureMapSize, x_48847312_3f06f9be_bumpmap, x_48847312_3f06f9be_bumpfactor, x_48847312_3f06f9be_bumpmapsize, x_48847312_3f06f9be_color, x_48847312_3f06f9be_angle, x_48847312_3f06f9be_flatnessmask1, x_48847312_3f06f9be_flatnessmask2);
    }
        objectID = 0;
...
{
    float _48847308Distance = object_Sphere(objPos(_48847308Matrix, p), x_48847308_6492bb9b_radius) * _48847308MinScale;
    float _48847312Distance = object_Desert(objPos(_48847312Matrix, p), x_48847312_1ec48586_freq, x_48847312_1ec48586_extranoise) * _48847312MinScale;
    result = opSubtract(float2(_48847308Distance, /*material ID*/0.5), float2(_48847312Distance, /*material ID*/1.5));
    }
	return result;
}
...
{
LightInfo light;
light.posAndRange = light_48847405PosAndRange;
light.colorAndIntensity = light_48847405ColorAndIntensity;
light.direction = light_48847405Direction;
lightValue += getDirectionalLight(input, light)* softshadow(input.pos, -light.direction, INFINITY, light_48847405Penumbra, light_48847405ShadowSteps);
}
{
LightInfo light;
light.posAndRange = light2_48847345PosAndRange;
light.colorAndIntensity = light2_48847345ColorAndIntensity;
light.direction = light2_48847345Direction;
