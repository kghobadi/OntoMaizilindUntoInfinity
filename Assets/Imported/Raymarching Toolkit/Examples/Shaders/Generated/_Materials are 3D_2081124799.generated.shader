...
// Light Main Light
uniform float4 MainLight_1565092189PosAndRange;
uniform float4 MainLight_1565092189ColorAndIntensity;
uniform float3 MainLight_1565092189Direction;
uniform float MainLight_1565092189Penumbra;
uniform int MainLight_1565092189ShadowSteps;
// Light Fill Light
uniform float4 FillLight_1565092181PosAndRange;
uniform float4 FillLight_1565092181ColorAndIntensity;
uniform float3 FillLight_1565092181Direction;
uniform float FillLight_1565092181Penumbra;
uniform int FillLight_1565092181ShadowSteps;

// UNIFORMS AND FUNCTIONS
uniform float x_1565092065_ce8993a9_x;
uniform float x_1565092065_ce8993a9_y;
uniform float x_1565092065_ce8993a9_z;
uniform float x_1565092127_ce8993a9_x;
uniform float x_1565092127_ce8993a9_y;
uniform float x_1565092127_ce8993a9_z;
...
uniform float x_1565092030_eabc26f4_radius;
uniform float x_1565092030_eabc26f4_thickness;
uniform float x_1565092030_eabc26f4_frequency;
uniform float x_1565092030_eabc26f4_displacement;
...
uniform float x_1565092090_6492bb9b_radius;
...
uniform float4x4 _1565092065Matrix;
uniform float _1565092065MinScale;
// uniforms for Subtract Box
uniform float4x4 _1565092127Matrix;
uniform float _1565092127MinScale;
// uniforms for Torus
uniform float4x4 _1565092030Matrix;
uniform float _1565092030MinScale;
// uniforms for Egg
uniform float4x4 _1565092090Matrix;
uniform float _1565092090MinScale;
uniform float2 x_1565092065_07ee3232_position;
uniform sampler2D x_1565092065_07ee3232_gradient;
...
uniform float4 x_1565092127_da843a44_color;
...
uniform float x_1565092030_3afa1872_distance;
uniform float x_1565092090_3afa1872_distance;
float3 material_EggMaterial(inout float3 normal, float3 p, float3 rayDir, float _INP_distance) {
    // Generated from Assets/Imported/Raymarching Toolkit/Examples/Assets/_Snippets/Egg Material.asset
...
float3 MaterialFunc(float nf, inout float3 normal, float3 p, float3 rayDir, out float objectID)
{
    ...
    [branch] if (nf <= 1) {
    //    objectID = 0.25;
        return material_Gradient(normal, objPos(_1565092065Matrix, p), rayDir, x_1565092065_07ee3232_position, x_1565092065_07ee3232_gradient);
    }
    else if(nf <= 2) {
    //    objectID = 0.5;
        return material_SimpleColor(normal, objPos(_1565092127Matrix, p), rayDir, x_1565092127_da843a44_color);
    }
    else if(nf <= 3) {
    //    objectID = 0.75;
        return material_EggMaterial(normal, objPos(_1565092030Matrix, p), rayDir, x_1565092030_3afa1872_distance);
    }
    else if(nf <= 4) {
    //    objectID = 1;
        return material_EggMaterial(normal, objPos(_1565092090Matrix, p), rayDir, x_1565092090_3afa1872_distance);
    }
        objectID = 0;
...
{
    float _1565092065Distance = object_Box(objPos(_1565092065Matrix, p), x_1565092065_ce8993a9_x, x_1565092065_ce8993a9_y, x_1565092065_ce8993a9_z) * _1565092065MinScale;
    float _1565092127Distance = object_Box(objPos(_1565092127Matrix, p), x_1565092127_ce8993a9_x, x_1565092127_ce8993a9_y, x_1565092127_ce8993a9_z) * _1565092127MinScale;
    float _1565092030Distance = object_Torus(objPos(_1565092030Matrix, p), x_1565092030_eabc26f4_radius, x_1565092030_eabc26f4_thickness, x_1565092030_eabc26f4_frequency, x_1565092030_eabc26f4_displacement) * _1565092030MinScale;
    float _1565092090Distance = object_Sphere(objPos(_1565092090Matrix, p), x_1565092090_6492bb9b_radius) * _1565092090MinScale;
    result = opU(float2(_1565092065Distance, /*material ID*/0.5), opSubtract(float2(_1565092127Distance, /*material ID*/1.5), opU(float2(_1565092030Distance, /*material ID*/2.5), float2(_1565092090Distance, /*material ID*/3.5))));
    }
	return result;
}
...
{
LightInfo light;
light.posAndRange = MainLight_1565092189PosAndRange;
light.colorAndIntensity = MainLight_1565092189ColorAndIntensity;
light.direction = MainLight_1565092189Direction;
lightValue += getDirectionalLight(input, light);
}
{
LightInfo light;
light.posAndRange = FillLight_1565092181PosAndRange;
light.colorAndIntensity = FillLight_1565092181ColorAndIntensity;
light.direction = FillLight_1565092181Direction;
lightValue += getDirectionalLight(input, light);
}
	return lightValue;
}
