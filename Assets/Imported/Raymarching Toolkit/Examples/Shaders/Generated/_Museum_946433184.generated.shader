...
// Light Light
uniform float4 Light_1565096804PosAndRange;
uniform float4 Light_1565096804ColorAndIntensity;
uniform float3 Light_1565096804Direction;
uniform float Light_1565096804Penumbra;
uniform int Light_1565096804ShadowSteps;
// Light Light (1)
uniform float4 Light1_1565118810PosAndRange;
uniform float4 Light1_1565118810ColorAndIntensity;
uniform float3 Light1_1565118810Direction;
uniform float Light1_1565118810Penumbra;
uniform int Light1_1565118810ShadowSteps;

// UNIFORMS AND FUNCTIONS
uniform float3 x_1565119810_86f1660c_offset;
uniform float x_1565119810_86f1660c_angle;
uniform float3 x_1565119810_86f1660c_axis;
uniform float3 x_1565119802_86f1660c_offset;
uniform float x_1565119802_86f1660c_angle;
uniform float3 x_1565119802_86f1660c_axis;
...
uniform float4x4 _1565119810Matrix;
uniform float4x4 _1565119810InverseMatrix;
uniform float4x4 _1565119802Matrix;
uniform float4x4 _1565119802InverseMatrix;
uniform float3 x_1565119804_b2cbb042_size;
uniform float x_1565119804_b2cbb042_roundedness;
...
uniform float x_1565096955_ce8993a9_x;
uniform float x_1565096955_ce8993a9_y;
uniform float x_1565096955_ce8993a9_z;
...
uniform float4x4 _1565119804Matrix;
uniform float _1565119804MinScale;
// uniforms for Platform
uniform float4x4 _1565096955Matrix;
uniform float _1565096955MinScale;
uniform float2 x_1565119804_07ee3232_position;
uniform sampler2D x_1565119804_07ee3232_gradient;
...
uniform float4 x_1565096955_da843a44_color;
...
float3 MaterialFunc(float nf, inout float3 normal, float3 p, float3 rayDir, out float objectID)
{
    ...
    [branch] if (nf <= 1) {
    //    objectID = 0.5;
        return material_Gradient(normal, objPos(_1565119804Matrix, p), rayDir, x_1565119804_07ee3232_position, x_1565119804_07ee3232_gradient);
    }
    else if(nf <= 2) {
    //    objectID = 1;
        return material_SimpleColor(normal, objPos(_1565096955Matrix, p), rayDir, x_1565096955_da843a44_color);
    }
        objectID = 0;
...
{
    float3 p_1565119810 = objPos(_1565119810InverseMatrix, modifier_Twist(objPos(_1565119810Matrix, p), x_1565119810_86f1660c_offset, x_1565119810_86f1660c_angle, x_1565119810_86f1660c_axis));
    float3 p_1565119802 = objPos(_1565119802InverseMatrix, modifier_Twist(objPos(_1565119802Matrix, p_1565119810), x_1565119802_86f1660c_offset, x_1565119802_86f1660c_angle, x_1565119802_86f1660c_axis));
    float _1565119804Distance = object_RoundedBox(objPos(_1565119804Matrix, p_1565119802), x_1565119804_b2cbb042_size, x_1565119804_b2cbb042_roundedness) * _1565119804MinScale;
    float _1565096955Distance = object_Box(objPos(_1565096955Matrix, p), x_1565096955_ce8993a9_x, x_1565096955_ce8993a9_y, x_1565096955_ce8993a9_z) * _1565096955MinScale;
    result = opU(float2(_1565119804Distance, /*material ID*/0.5), float2(_1565096955Distance, /*material ID*/1.5));
    }
	return result;
}
...
{
LightInfo light;
light.posAndRange = Light_1565096804PosAndRange;
light.colorAndIntensity = Light_1565096804ColorAndIntensity;
light.direction = Light_1565096804Direction;
lightValue += getDirectionalLight(input, light);
}
{
LightInfo light;
light.posAndRange = Light1_1565118810PosAndRange;
light.colorAndIntensity = Light1_1565118810ColorAndIntensity;
light.direction = Light1_1565118810Direction;
lightValue += getDirectionalLight(input, light);
}
	return lightValue;
}
