...
// Light Light
uniform float4 Light_1565118905PosAndRange;
uniform float4 Light_1565118905ColorAndIntensity;
uniform float3 Light_1565118905Direction;
uniform float Light_1565118905Penumbra;
uniform int Light_1565118905ShadowSteps;
// Light Light (1)
uniform float4 Light1_1565119033PosAndRange;
uniform float4 Light1_1565119033ColorAndIntensity;
uniform float3 Light1_1565119033Direction;
uniform float Light1_1565119033Penumbra;
uniform int Light1_1565119033ShadowSteps;
// Light Light (2)
uniform float4 Light2_1565120056PosAndRange;
uniform float4 Light2_1565120056ColorAndIntensity;
uniform float3 Light2_1565120056Direction;
uniform float Light2_1565120056Penumbra;
uniform int Light2_1565120056ShadowSteps;

// UNIFORMS AND FUNCTIONS
uniform float x_1565094074_8794b49b_height;
uniform float x_1565094074_8794b49b_frequency;
uniform float2 x_1565094074_8794b49b_clamp;
uniform float x_1565094074_8794b49b_offset;
float3 modifier_ExampleYDisplacement(float3 p , float _INP_height, float _INP_frequency, float2 _INP_clamp, float _INP_offset) {
    // Generated from Assets/Imported/Raymarching Toolkit/Examples/Assets/_Snippets/Example Y Displacement.asset
...
uniform float4x4 _1565094074Matrix;
uniform float4x4 _1565094074InverseMatrix;
uniform float x_1565120951_ce8993a9_x;
uniform float x_1565120951_ce8993a9_y;
uniform float x_1565120951_ce8993a9_z;
...
uniform float x_1565095785_6492bb9b_radius;
uniform float x_1565117857_6492bb9b_radius;
uniform float x_1565121695_6492bb9b_radius;
uniform float x_1565095072_6492bb9b_radius;
...
uniform float4x4 _1565120951Matrix;
uniform float _1565120951MinScale;
// uniforms for Sphere
uniform float4x4 _1565095785Matrix;
uniform float _1565095785MinScale;
// uniforms for Sphere
uniform float4x4 _1565117857Matrix;
uniform float _1565117857MinScale;
// uniforms for Sphere
uniform float4x4 _1565121695Matrix;
uniform float _1565121695MinScale;
// uniforms for Sphere
uniform float4x4 _1565095072Matrix;
uniform float _1565095072MinScale;
uniform int x_1565094076_d6c1f870_steps;
uniform float x_1565094076_d6c1f870_intensity;
...
uniform float4 x_1565120951_da843a44_color;
...
uniform float2 x_1565095785_07ee3232_position;
uniform sampler2D x_1565095785_07ee3232_gradient;
uniform float2 x_1565117857_07ee3232_position;
uniform sampler2D x_1565117857_07ee3232_gradient;
uniform float2 x_1565121695_07ee3232_position;
uniform sampler2D x_1565121695_07ee3232_gradient;
uniform float2 x_1565095072_07ee3232_position;
uniform sampler2D x_1565095072_07ee3232_gradient;
...
float3 MaterialFunc(float nf, inout float3 normal, float3 p, float3 rayDir, out float objectID)
{
    ...
    [branch] if (nf <= 1) {
    //    objectID = 0.2;
        return material_SimpleColor(normal, objPos(_1565120951Matrix, p), rayDir, x_1565120951_da843a44_color);
    }
    else if(nf <= 2) {
    //    objectID = 0.4;
        return material_Gradient(normal, objPos(_1565095785Matrix, p), rayDir, x_1565095785_07ee3232_position, x_1565095785_07ee3232_gradient);
    }
    else if(nf <= 3) {
    //    objectID = 0.6;
        return material_Gradient(normal, objPos(_1565117857Matrix, p), rayDir, x_1565117857_07ee3232_position, x_1565117857_07ee3232_gradient);
    }
    else if(nf <= 4) {
    //    objectID = 0.8;
        return material_Gradient(normal, objPos(_1565121695Matrix, p), rayDir, x_1565121695_07ee3232_position, x_1565121695_07ee3232_gradient);
    }
    else if(nf <= 5) {
    //    objectID = 1;
        return material_Gradient(normal, objPos(_1565095072Matrix, p), rayDir, x_1565095072_07ee3232_position, x_1565095072_07ee3232_gradient);
    }
        objectID = 0;
...
{
    float _1565120951Distance = object_Box(objPos(_1565120951Matrix, p), x_1565120951_ce8993a9_x, x_1565120951_ce8993a9_y, x_1565120951_ce8993a9_z) * _1565120951MinScale;
    float3 p_1565094074 = objPos(_1565094074InverseMatrix, modifier_ExampleYDisplacement(objPos(_1565094074Matrix, p), x_1565094074_8794b49b_height, x_1565094074_8794b49b_frequency, x_1565094074_8794b49b_clamp, x_1565094074_8794b49b_offset));
    float _1565095785Distance = object_Sphere(objPos(_1565095785Matrix, p_1565094074), x_1565095785_6492bb9b_radius) * _1565095785MinScale;
    float _1565117857Distance = object_Sphere(objPos(_1565117857Matrix, p_1565094074), x_1565117857_6492bb9b_radius) * _1565117857MinScale;
    float _1565121695Distance = object_Sphere(objPos(_1565121695Matrix, p_1565094074), x_1565121695_6492bb9b_radius) * _1565121695MinScale;
    float _1565095072Distance = object_Sphere(objPos(_1565095072Matrix, p_1565094074), x_1565095072_6492bb9b_radius) * _1565095072MinScale;
    result = opU(float2(_1565120951Distance, /*material ID*/0.5), blend_Stairs(blend_Stairs(blend_Stairs(float2(_1565095785Distance, /*material ID*/1.5), float2(_1565117857Distance, /*material ID*/2.5), x_1565094076_d6c1f870_steps, x_1565094076_d6c1f870_intensity), float2(_1565121695Distance, /*material ID*/3.5), x_1565094076_d6c1f870_steps, x_1565094076_d6c1f870_intensity), float2(_1565095072Distance, /*material ID*/4.5), x_1565094076_d6c1f870_steps, x_1565094076_d6c1f870_intensity));
    }
	return result;
}
...
{
LightInfo light;
light.posAndRange = Light_1565118905PosAndRange;
light.colorAndIntensity = Light_1565118905ColorAndIntensity;
light.direction = Light_1565118905Direction;
lightValue += getDirectionalLight(input, light);
}
{
LightInfo light;
light.posAndRange = Light1_1565119033PosAndRange;
light.colorAndIntensity = Light1_1565119033ColorAndIntensity;
light.direction = Light1_1565119033Direction;
lightValue += getDirectionalLight(input, light);
}
{
LightInfo light;
light.posAndRange = Light2_1565120056PosAndRange;
light.colorAndIntensity = Light2_1565120056ColorAndIntensity;
light.direction = Light2_1565120056Direction;
lightValue += getDirectionalLight(input, light);
}
	return lightValue;
}
