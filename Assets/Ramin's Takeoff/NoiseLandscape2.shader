...
Shader "Julian/NoiseLandscape2"
{
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutputCustomLightingCustom o )
		{
			...
			half4 temp_output_201_0 = ( trunc( ( tex2D( _MainTexture, uv_MainTexture ) * temp_output_3_0_g44 ) ) / temp_output_3_0_g44 );
			#if defined(LIGHTMAP_ON) && ( UNITY_VERSION < 560 || ( defined(LIGHTMAP_SHADOW_MIXING) && !defined(SHADOWS_SHADOWMASK) && defined(SHADOWS_SCREEN) ) )//aselc
			half4 ase_lightColor = 0;
			#else //aselc
			half4 ase_lightColor = _LightColor0;
...
/*ASEBEGIN
Version=18912
243;552;1906;890;138.3068;242.3413;1.3;True;True
...
Node;AmplifyShaderEditor.Vector2Node;228;-833.5276,-42.26625;Inherit;False;Property;_NoiseSpeed;NoiseSpeed;9;0;Create;True;0;0;0;False;0;False;500,500;0,-1;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
...
Node;AmplifyShaderEditor.PannerNode;224;-575.5635,-31.5367;Inherit;False;3;0;FLOAT2;0,0;False;2;FLOAT2;0,-1.5;False;1;FLOAT;1;False;1;FLOAT2;0
Node;AmplifyShaderEditor.Vector2Node;227;-583.8847,-173.745;Inherit;False;Property;_NoiseTiling;NoiseTiling;10;0;Create;True;0;0;0;False;0;False;500,500;13,159.2;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
...
Node;AmplifyShaderEditor.LightColorNode;163;407.6152,-98.56223;Inherit;False;0;3;COLOR;0;FLOAT3;1;FLOAT;2
...
Node;AmplifyShaderEditor.ColorNode;31;808.1142,-249.4103;Inherit;False;Property;_Albedo;Albedo;0;0;Create;True;0;0;0;False;0;False;1,1,1,1;0,0.2333653,1,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.GradientSampleNode;217;1419.007,-787.8878;Inherit;True;2;0;OBJECT;;False;1;FLOAT;0;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;162;1097.995,-144.5202;Inherit;True;2;2;0;COLOR;0,0,0,0;False;1;COLOR;1,1,1,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.ColorNode;192;248.2872,-591.7276;Inherit;False;Property;_GradientEnd;GradientEnd;7;0;Create;True;0;0;0;False;0;False;0,0,0,0;1,1,1,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.ColorNode;191;237.4134,-396.7461;Inherit;False;Property;_GradientStart;GradientStart;6;0;Create;True;0;0;0;False;0;False;1,1,1,0;0.7921569,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
ASEEND*/
//CHKSM=5FCE48E494D1CC1EAA204E6B4AA0347B97CA86E9