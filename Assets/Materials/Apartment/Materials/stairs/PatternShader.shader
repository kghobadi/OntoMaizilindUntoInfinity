...
Shader "Julian/PatternShader"
{
	...
	SubShader
	{
		...
		inline half4 LightingStandardCustomLighting( inout SurfaceOutputCustomLightingCustom s, half3 viewDir, UnityGI gi )
		{
			...
			c.rgb = ( (( _UseLight )?( 1.0 ):( 0.0 )) == 0.0 ? float4( 0,0,0,0 ) : ( mainTex85 * light73 ) ).rgb;
			c.a = 1;
			return c;
		}
...
/*ASEBEGIN
Version=18912
117;224;1169;710;900.2925;558.5846;1.808877;True;True
...
Node;AmplifyShaderEditor.Compare;115;199.5157,75.85757;Inherit;False;0;4;0;FLOAT;0;False;1;FLOAT;0;False;2;COLOR;0,0,0,0;False;3;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.Compare;116;204.0297,-87.48822;Inherit;False;0;4;0;FLOAT;0;False;1;FLOAT;1;False;2;COLOR;0,0,0,0;False;3;COLOR;0,0,0,0;False;1;COLOR;0
...
ASEEND*/
//CHKSM=A6466E37B0239D6FC27644B88F40EBFB37B23ECB