...
Shader "Julian/PatternShader"
{
	...
	SubShader
	{
		...
		uniform float4 _Tex2TilingOffset;
		...
		inline half4 LightingStandardCustomLighting( inout SurfaceOutputCustomLightingCustom s, half3 viewDir, UnityGI gi )
		{
			...
			float2 appendResult94 = (float2(_Tex2TilingOffset.x , _Tex2TilingOffset.y));
			float2 appendResult93 = (float2(_Tex2TilingOffset.z , _Tex2TilingOffset.w));
			float2 uv_TexCoord81 = i.uv_texcoord * appendResult94 + ( _Time.x * appendResult93 );
			float4 temp_output_84_0 = ( ( tex2D( _MainTex, uv_TexCoord51 ) * _Color1 ) + ( tex2D( _MainTex, uv_TexCoord81 ) * _Color2 ) );
			float maskRange104 = _MaskRange;
			float4 mainTex85 = ( ( saturate( ( 1.0 - ( ( distance( _Color1.rgb , temp_output_84_0.rgb ) - maskRange104 ) / max( 0.0 , 1E-05 ) ) ) ) * _Color1 ) + ( saturate( ( 1.0 - ( ( distance( _Color2.rgb , temp_output_84_0.rgb ) - maskRange104 ) / max( 0.0 , 1E-05 ) ) ) ) * _Color2 ) );
			...
			float4 temp_cast_4 = (( ( ase_lightColor.a * ase_lightAtten ) * saturate( dotResult6 ) )).xxxx;
			float4 lerpResult29 = lerp( ( ase_lightColor * ase_lightAtten ) , float4( 0,0,0,0 ) , saturate( ( 1.0 - trunc( CalculateContrast(4.0,temp_cast_4) ) ) ));
			float4 light73 = saturate( lerpResult29 );
...
/*ASEBEGIN
Version=18912
209;564;1169;732;1260.623;1611.049;2.677748;True;True
...
Node;AmplifyShaderEditor.Vector4Node;89;-1101.271,-1345.145;Inherit;False;Property;_Tex1TilingOffset;Tex1Tiling&Offset;3;0;Create;True;0;0;0;False;0;False;0.5,0.5,1,1;0.2,0.2,0,0;0;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.Vector4Node;92;-1095.417,-932.4792;Inherit;False;Property;_Tex2TilingOffset;Tex2Tiling&Offset;4;0;Create;True;0;0;0;False;0;False;0.5,0.5,1,1;1,1,0.05,0.02;0;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.TexturePropertyNode;61;-1383.635,-1685.139;Inherit;True;Property;_MainTex;MainTex;2;1;[NoScaleOffset];Create;True;0;0;0;False;0;False;None;e49c251a37bfe8f4b97a7bcff572613c;False;white;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
...
Node;AmplifyShaderEditor.FunctionNode;97;497.0008,-1323.682;Inherit;True;Color Mask;-1;;3;eec747d987850564c95bde0e5a6d1867;0;4;1;FLOAT3;0,0,0;False;3;FLOAT3;0,0,0;False;4;FLOAT;0.7;False;5;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;99;512.5987,-1086.67;Inherit;True;Color Mask;-1;;4;eec747d987850564c95bde0e5a6d1867;0;4;1;FLOAT3;0,0,0;False;3;FLOAT3;0,0,0;False;4;FLOAT;0.7;False;5;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.StandardSurfaceOutputNode;0;522.5167,-8.649698;Float;False;True;-1;2;ASEMaterialInspector;0;0;CustomLighting;Julian/PatternShader;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;Back;0;False;-1;0;False;-1;False;0;False;-1;0;False;-1;False;0;Opaque;0.5;True;True;0;False;Opaque;;Geometry;ForwardOnly;18;all;True;True;True;True;0;False;-1;False;0;False;-1;255;False;-1;255;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;False;2;15;10;25;False;0.5;True;0;0;False;-1;0;False;-1;0;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;True;0.05;0,0,0,0;VertexOffset;True;False;Cylindrical;False;Relative;0;;-1;-1;-1;-1;0;False;0;0;False;-1;-1;0;False;-1;0;0;0;False;0.1;False;-1;0;False;-1;False;15;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;2;FLOAT3;0,0,0;False;3;FLOAT3;0,0,0;False;4;FLOAT;0;False;6;FLOAT3;0,0,0;False;7;FLOAT3;0,0,0;False;8;FLOAT;0;False;9;FLOAT;0;False;10;FLOAT;0;False;13;FLOAT3;0,0,0;False;11;FLOAT3;0,0,0;False;12;FLOAT3;0,0,0;False;14;FLOAT4;0,0,0,0;False;15;FLOAT3;0,0,0;False;0
...
ASEEND*/
//CHKSM=6A3D98FD2E60884490BE01E7C5E907C243C5122A