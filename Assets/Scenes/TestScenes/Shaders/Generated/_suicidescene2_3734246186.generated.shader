Shader "Hidden/_suicidescene2_3734246186.generated"
{
...
uniform int x_133252974_1d0a4544_iterations;
uniform float x_133252974_1d0a4544_bailout;
uniform float x_133252974_1d0a4544_power;
...
uniform float4x4 _133252974Matrix;
uniform float _133252974MinScale;
uniform float2 x_133252974_07ee3232_position;
uniform sampler2D x_133252974_07ee3232_gradient;
...
float3 MaterialFunc(float nf, inout float3 normal, float3 p, float3 rayDir, out float objectID)
{
    ...
    [branch] if (nf <= 1) {
    //    objectID = 1;
        return material_Gradient(normal, objPos(_133252974Matrix, p), rayDir, x_133252974_07ee3232_position, x_133252974_07ee3232_gradient);
    }
        objectID = 0;
...
{
    float _133252974Distance = object_FractalMandelbub(objPos(_133252974Matrix, p), x_133252974_1d0a4544_iterations, x_133252974_1d0a4544_bailout, x_133252974_1d0a4544_power) * _133252974MinScale;
    result = float2(_133252974Distance, /*material ID*/0,5);
    }
	return result;
}
