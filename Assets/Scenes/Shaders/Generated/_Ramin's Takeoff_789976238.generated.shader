...
uniform float2 x_2081084942_1ec48586_freq;
uniform float2 x_2081084942_1ec48586_extranoise;
...
uniform float4x4 _2081084942Matrix;
uniform float _2081084942MinScale;
uniform sampler2D x_2081084942_3f06f9be_textureMap;
uniform float x_2081084942_3f06f9be_textureMapSize;
uniform sampler2D x_2081084942_3f06f9be_bumpmap;
uniform float x_2081084942_3f06f9be_bumpfactor;
uniform float x_2081084942_3f06f9be_bumpmapsize;
uniform float4 x_2081084942_3f06f9be_color;
uniform float x_2081084942_3f06f9be_angle;
uniform float2 x_2081084942_3f06f9be_flatnessmask1;
uniform float2 x_2081084942_3f06f9be_flatnessmask2;
...
float3 MaterialFunc(float nf, inout float3 normal, float3 p, float3 rayDir, out float objectID)
{
    ...
    [branch] if (nf <= 1) {
    //    objectID = 1;
        return material_DesertMaterial(normal, objPos(_2081084942Matrix, p), rayDir, x_2081084942_3f06f9be_textureMap, x_2081084942_3f06f9be_textureMapSize, x_2081084942_3f06f9be_bumpmap, x_2081084942_3f06f9be_bumpfactor, x_2081084942_3f06f9be_bumpmapsize, x_2081084942_3f06f9be_color, x_2081084942_3f06f9be_angle, x_2081084942_3f06f9be_flatnessmask1, x_2081084942_3f06f9be_flatnessmask2);
    }
        objectID = 0;
...
{
    float _2081084942Distance = object_Desert(objPos(_2081084942Matrix, p), x_2081084942_1ec48586_freq, x_2081084942_1ec48586_extranoise) * _2081084942MinScale;
    result = float2(_2081084942Distance, /*material ID*/0.5);
    }
	return result;
}
