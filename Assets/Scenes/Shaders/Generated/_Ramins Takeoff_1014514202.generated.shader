...
uniform float2 x_48672443_1ec48586_freq;
uniform float2 x_48672443_1ec48586_extranoise;
...
uniform float4x4 _48672443Matrix;
uniform float _48672443MinScale;
uniform sampler2D x_48672443_3f06f9be_textureMap;
uniform float x_48672443_3f06f9be_textureMapSize;
uniform sampler2D x_48672443_3f06f9be_bumpmap;
uniform float x_48672443_3f06f9be_bumpfactor;
uniform float x_48672443_3f06f9be_bumpmapsize;
uniform float4 x_48672443_3f06f9be_color;
uniform float x_48672443_3f06f9be_angle;
uniform float2 x_48672443_3f06f9be_flatnessmask1;
uniform float2 x_48672443_3f06f9be_flatnessmask2;
...
float3 MaterialFunc(float nf, inout float3 normal, float3 p, float3 rayDir, out float objectID)
{
    ...
    [branch] if (nf <= 1) {
    //    objectID = 1;
        return material_DesertMaterial(normal, objPos(_48672443Matrix, p), rayDir, x_48672443_3f06f9be_textureMap, x_48672443_3f06f9be_textureMapSize, x_48672443_3f06f9be_bumpmap, x_48672443_3f06f9be_bumpfactor, x_48672443_3f06f9be_bumpmapsize, x_48672443_3f06f9be_color, x_48672443_3f06f9be_angle, x_48672443_3f06f9be_flatnessmask1, x_48672443_3f06f9be_flatnessmask2);
    }
        objectID = 0;
...
{
    float _48672443Distance = object_Desert(objPos(_48672443Matrix, p), x_48672443_1ec48586_freq, x_48672443_1ec48586_extranoise) * _48672443MinScale;
    result = float2(_48672443Distance, /*material ID*/0.5);
    }
	return result;
}
