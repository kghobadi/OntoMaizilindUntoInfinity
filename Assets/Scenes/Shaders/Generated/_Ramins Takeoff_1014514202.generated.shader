...
uniform float2 x_50698130_1ec48586_freq;
uniform float2 x_50698130_1ec48586_extranoise;
...
uniform float4x4 _50698130Matrix;
uniform float _50698130MinScale;
uniform sampler2D x_50698130_3f06f9be_textureMap;
uniform float x_50698130_3f06f9be_textureMapSize;
uniform sampler2D x_50698130_3f06f9be_bumpmap;
uniform float x_50698130_3f06f9be_bumpfactor;
uniform float x_50698130_3f06f9be_bumpmapsize;
uniform float4 x_50698130_3f06f9be_color;
uniform float x_50698130_3f06f9be_angle;
uniform float2 x_50698130_3f06f9be_flatnessmask1;
uniform float2 x_50698130_3f06f9be_flatnessmask2;
...
float3 MaterialFunc(float nf, inout float3 normal, float3 p, float3 rayDir, out float objectID)
{
    ...
    [branch] if (nf <= 1) {
    //    objectID = 1;
        return material_DesertMaterial(normal, objPos(_50698130Matrix, p), rayDir, x_50698130_3f06f9be_textureMap, x_50698130_3f06f9be_textureMapSize, x_50698130_3f06f9be_bumpmap, x_50698130_3f06f9be_bumpfactor, x_50698130_3f06f9be_bumpmapsize, x_50698130_3f06f9be_color, x_50698130_3f06f9be_angle, x_50698130_3f06f9be_flatnessmask1, x_50698130_3f06f9be_flatnessmask2);
    }
        objectID = 0;
...
{
    float _50698130Distance = object_Desert(objPos(_50698130Matrix, p), x_50698130_1ec48586_freq, x_50698130_1ec48586_extranoise) * _50698130MinScale;
    result = float2(_50698130Distance, /*material ID*/0.5);
    }
	return result;
}
