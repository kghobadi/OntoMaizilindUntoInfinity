...
uniform float2 x_53379483_1ec48586_freq;
uniform float2 x_53379483_1ec48586_extranoise;
...
uniform float4x4 _53379483Matrix;
uniform float _53379483MinScale;
uniform sampler2D x_53379483_3f06f9be_textureMap;
uniform float x_53379483_3f06f9be_textureMapSize;
uniform sampler2D x_53379483_3f06f9be_bumpmap;
uniform float x_53379483_3f06f9be_bumpfactor;
uniform float x_53379483_3f06f9be_bumpmapsize;
uniform float4 x_53379483_3f06f9be_color;
uniform float x_53379483_3f06f9be_angle;
uniform float2 x_53379483_3f06f9be_flatnessmask1;
uniform float2 x_53379483_3f06f9be_flatnessmask2;
...
float3 MaterialFunc(float nf, inout float3 normal, float3 p, float3 rayDir, out float objectID)
{
    ...
    [branch] if (nf <= 1) {
    //    objectID = 1;
        return material_DesertMaterial(normal, objPos(_53379483Matrix, p), rayDir, x_53379483_3f06f9be_textureMap, x_53379483_3f06f9be_textureMapSize, x_53379483_3f06f9be_bumpmap, x_53379483_3f06f9be_bumpfactor, x_53379483_3f06f9be_bumpmapsize, x_53379483_3f06f9be_color, x_53379483_3f06f9be_angle, x_53379483_3f06f9be_flatnessmask1, x_53379483_3f06f9be_flatnessmask2);
    }
        objectID = 0;
...
{
    float _53379483Distance = object_Desert(objPos(_53379483Matrix, p), x_53379483_1ec48586_freq, x_53379483_1ec48586_extranoise) * _53379483MinScale;
    result = float2(_53379483Distance, /*material ID*/0.5);
    }
	return result;
}
