...
uniform float2 x_52514513_1ec48586_freq;
uniform float2 x_52514513_1ec48586_extranoise;
...
uniform float4x4 _52514513Matrix;
uniform float _52514513MinScale;
uniform sampler2D x_52514513_3f06f9be_textureMap;
uniform float x_52514513_3f06f9be_textureMapSize;
uniform sampler2D x_52514513_3f06f9be_bumpmap;
uniform float x_52514513_3f06f9be_bumpfactor;
uniform float x_52514513_3f06f9be_bumpmapsize;
uniform float4 x_52514513_3f06f9be_color;
uniform float x_52514513_3f06f9be_angle;
uniform float2 x_52514513_3f06f9be_flatnessmask1;
uniform float2 x_52514513_3f06f9be_flatnessmask2;
...
float3 MaterialFunc(float nf, inout float3 normal, float3 p, float3 rayDir, out float objectID)
{
    ...
    [branch] if (nf <= 1) {
    //    objectID = 1;
        return material_DesertMaterial(normal, objPos(_52514513Matrix, p), rayDir, x_52514513_3f06f9be_textureMap, x_52514513_3f06f9be_textureMapSize, x_52514513_3f06f9be_bumpmap, x_52514513_3f06f9be_bumpfactor, x_52514513_3f06f9be_bumpmapsize, x_52514513_3f06f9be_color, x_52514513_3f06f9be_angle, x_52514513_3f06f9be_flatnessmask1, x_52514513_3f06f9be_flatnessmask2);
    }
        objectID = 0;
...
{
    float _52514513Distance = object_Desert(objPos(_52514513Matrix, p), x_52514513_1ec48586_freq, x_52514513_1ec48586_extranoise) * _52514513MinScale;
    result = float2(_52514513Distance, /*material ID*/0.5);
    }
	return result;
}
