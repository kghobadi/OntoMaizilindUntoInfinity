...
Shader "Hidden/_Hallucinations Workshop_3948868333.generated"
{
...
uniform float2 x_51475831_1ec48586_freq;
uniform float2 x_51475831_1ec48586_extranoise;
...
uniform float4x4 _51475831Matrix;
uniform float _51475831MinScale;
uniform sampler2D x_51475831_3f06f9be_textureMap;
uniform float x_51475831_3f06f9be_textureMapSize;
uniform sampler2D x_51475831_3f06f9be_bumpmap;
uniform float x_51475831_3f06f9be_bumpfactor;
uniform float x_51475831_3f06f9be_bumpmapsize;
uniform float4 x_51475831_3f06f9be_color;
uniform float x_51475831_3f06f9be_angle;
uniform float2 x_51475831_3f06f9be_flatnessmask1;
uniform float2 x_51475831_3f06f9be_flatnessmask2;
...
float3 MaterialFunc(float nf, inout float3 normal, float3 p, float3 rayDir, out float objectID)
{
    ...
    [branch] if (nf <= 1) {
    //    objectID = 1;
        return material_DesertMaterial(normal, objPos(_51475831Matrix, p), rayDir, x_51475831_3f06f9be_textureMap, x_51475831_3f06f9be_textureMapSize, x_51475831_3f06f9be_bumpmap, x_51475831_3f06f9be_bumpfactor, x_51475831_3f06f9be_bumpmapsize, x_51475831_3f06f9be_color, x_51475831_3f06f9be_angle, x_51475831_3f06f9be_flatnessmask1, x_51475831_3f06f9be_flatnessmask2);
    }
        objectID = 0;
...
{
    float _51475831Distance = object_Desert(objPos(_51475831Matrix, p), x_51475831_1ec48586_freq, x_51475831_1ec48586_extranoise) * _51475831MinScale;
    result = float2(_51475831Distance, /*material ID*/0.5);
    }
	return result;
}
