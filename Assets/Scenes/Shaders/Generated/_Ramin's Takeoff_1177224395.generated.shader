...
Shader "Hidden/_Ramin's Takeoff_1177224395.generated"
{
...
uniform float2 x_2714727991_1ec48586_freq;
uniform float2 x_2714727991_1ec48586_extranoise;
...
uniform float4x4 _2714727991Matrix;
uniform float _2714727991MinScale;
uniform sampler2D x_2714727991_3f06f9be_textureMap;
uniform float x_2714727991_3f06f9be_textureMapSize;
uniform sampler2D x_2714727991_3f06f9be_bumpmap;
uniform float x_2714727991_3f06f9be_bumpfactor;
uniform float x_2714727991_3f06f9be_bumpmapsize;
uniform float4 x_2714727991_3f06f9be_color;
uniform float x_2714727991_3f06f9be_angle;
uniform float2 x_2714727991_3f06f9be_flatnessmask1;
uniform float2 x_2714727991_3f06f9be_flatnessmask2;
...
float3 MaterialFunc(float nf, inout float3 normal, float3 p, float3 rayDir, out float objectID)
{
    ...
    [branch] if (nf <= 1) {
    //    objectID = 1;
        return material_DesertMaterial(normal, objPos(_2714727991Matrix, p), rayDir, x_2714727991_3f06f9be_textureMap, x_2714727991_3f06f9be_textureMapSize, x_2714727991_3f06f9be_bumpmap, x_2714727991_3f06f9be_bumpfactor, x_2714727991_3f06f9be_bumpmapsize, x_2714727991_3f06f9be_color, x_2714727991_3f06f9be_angle, x_2714727991_3f06f9be_flatnessmask1, x_2714727991_3f06f9be_flatnessmask2);
    }
        objectID = 0;
...
{
    float _2714727991Distance = object_Desert(objPos(_2714727991Matrix, p), x_2714727991_1ec48586_freq, x_2714727991_1ec48586_extranoise) * _2714727991MinScale;
    result = float2(_2714727991Distance, /*material ID*/0.5);
    }
	return result;
}
