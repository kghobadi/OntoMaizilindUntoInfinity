...
uniform int x_502137233_1d0a4544_iterations;
uniform float x_502137233_1d0a4544_bailout;
uniform float x_502137233_1d0a4544_power;
...
uniform float4x4 _502137233Matrix;
uniform float _502137233MinScale;
uniform float2 x_502137233_07ee3232_position;
uniform sampler2D x_502137233_07ee3232_gradient;
...
float3 MaterialFunc(float nf, inout float3 normal, float3 p, float3 rayDir, out float objectID)
{
    ...
    [branch] if (nf <= 1) {
    //    objectID = 1;
        return material_Gradient(normal, objPos(_502137233Matrix, p), rayDir, x_502137233_07ee3232_position, x_502137233_07ee3232_gradient);
    }
        objectID = 0;
...
{
    float _502137233Distance = object_FractalMandelbub(objPos(_502137233Matrix, p), x_502137233_1d0a4544_iterations, x_502137233_1d0a4544_bailout, x_502137233_1d0a4544_power) * _502137233MinScale;
    result = float2(_502137233Distance, /*material ID*/0.5);
    }
	return result;
}
