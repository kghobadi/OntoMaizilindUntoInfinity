...
uniform int x_50696464_1d0a4544_iterations;
uniform float x_50696464_1d0a4544_bailout;
uniform float x_50696464_1d0a4544_power;
...
uniform float4x4 _50696464Matrix;
uniform float _50696464MinScale;
uniform float2 x_50696464_07ee3232_position;
uniform sampler2D x_50696464_07ee3232_gradient;
...
float3 MaterialFunc(float nf, inout float3 normal, float3 p, float3 rayDir, out float objectID)
{
    ...
    [branch] if (nf <= 1) {
    //    objectID = 1;
        return material_Gradient(normal, objPos(_50696464Matrix, p), rayDir, x_50696464_07ee3232_position, x_50696464_07ee3232_gradient);
    }
        objectID = 0;
...
{
    float _50696464Distance = object_FractalMandelbub(objPos(_50696464Matrix, p), x_50696464_1d0a4544_iterations, x_50696464_1d0a4544_bailout, x_50696464_1d0a4544_power) * _50696464MinScale;
    result = float2(_50696464Distance, /*material ID*/0.5);
    }
	return result;
}
