...
uniform int x_2852133719_1d0a4544_iterations;
uniform float x_2852133719_1d0a4544_bailout;
uniform float x_2852133719_1d0a4544_power;
...
uniform float4x4 _2852133719Matrix;
uniform float _2852133719MinScale;
uniform float2 x_2852133719_07ee3232_position;
uniform sampler2D x_2852133719_07ee3232_gradient;
...
float3 MaterialFunc(float nf, inout float3 normal, float3 p, float3 rayDir, out float objectID)
{
    ...
    [branch] if (nf <= 1) {
    //    objectID = 1;
        return material_Gradient(normal, objPos(_2852133719Matrix, p), rayDir, x_2852133719_07ee3232_position, x_2852133719_07ee3232_gradient);
    }
        objectID = 0;
...
{
    float _2852133719Distance = object_FractalMandelbub(objPos(_2852133719Matrix, p), x_2852133719_1d0a4544_iterations, x_2852133719_1d0a4544_bailout, x_2852133719_1d0a4544_power) * _2852133719MinScale;
    result = float2(_2852133719Distance, /*material ID*/0.5);
    }
	return result;
}
