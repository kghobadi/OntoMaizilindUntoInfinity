...
uniform int x_1569708709_1d0a4544_iterations;
uniform float x_1569708709_1d0a4544_bailout;
uniform float x_1569708709_1d0a4544_power;
...
uniform float4x4 _1569708709Matrix;
uniform float _1569708709MinScale;
uniform float2 x_1569708709_07ee3232_position;
uniform sampler2D x_1569708709_07ee3232_gradient;
...
float3 MaterialFunc(float nf, inout float3 normal, float3 p, float3 rayDir, out float objectID)
{
    ...
    [branch] if (nf <= 1) {
    //    objectID = 1;
        return material_Gradient(normal, objPos(_1569708709Matrix, p), rayDir, x_1569708709_07ee3232_position, x_1569708709_07ee3232_gradient);
    }
        objectID = 0;
...
{
    float _1569708709Distance = object_FractalMandelbub(objPos(_1569708709Matrix, p), x_1569708709_1d0a4544_iterations, x_1569708709_1d0a4544_bailout, x_1569708709_1d0a4544_power) * _1569708709MinScale;
    result = float2(_1569708709Distance, /*material ID*/0.5);
    }
	return result;
}
