...
uniform int x_2046675376_1d0a4544_iterations;
uniform float x_2046675376_1d0a4544_bailout;
uniform float x_2046675376_1d0a4544_power;
...
uniform float4x4 _2046675376Matrix;
uniform float _2046675376MinScale;
uniform float2 x_2046675376_07ee3232_position;
uniform sampler2D x_2046675376_07ee3232_gradient;
...
float3 MaterialFunc(float nf, inout float3 normal, float3 p, float3 rayDir, out float objectID)
{
    ...
    [branch] if (nf <= 1) {
    //    objectID = 1;
        return material_Gradient(normal, objPos(_2046675376Matrix, p), rayDir, x_2046675376_07ee3232_position, x_2046675376_07ee3232_gradient);
    }
        objectID = 0;
...
{
    float _2046675376Distance = object_FractalMandelbub(objPos(_2046675376Matrix, p), x_2046675376_1d0a4544_iterations, x_2046675376_1d0a4544_bailout, x_2046675376_1d0a4544_power) * _2046675376MinScale;
    result = float2(_2046675376Distance, /*material ID*/0.5);
    }
	return result;
}
