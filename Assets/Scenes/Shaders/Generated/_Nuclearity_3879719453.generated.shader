...
uniform int x_47805646_1d0a4544_iterations;
uniform float x_47805646_1d0a4544_bailout;
uniform float x_47805646_1d0a4544_power;
...
uniform float4x4 _47805646Matrix;
uniform float _47805646MinScale;
uniform float2 x_47805646_07ee3232_position;
uniform sampler2D x_47805646_07ee3232_gradient;
...
float3 MaterialFunc(float nf, inout float3 normal, float3 p, float3 rayDir, out float objectID)
{
    ...
    [branch] if (nf <= 1) {
    //    objectID = 1;
        return material_Gradient(normal, objPos(_47805646Matrix, p), rayDir, x_47805646_07ee3232_position, x_47805646_07ee3232_gradient);
    }
        objectID = 0;
...
{
    float _47805646Distance = object_FractalMandelbub(objPos(_47805646Matrix, p), x_47805646_1d0a4544_iterations, x_47805646_1d0a4544_bailout, x_47805646_1d0a4544_power) * _47805646MinScale;
    result = float2(_47805646Distance, /*material ID*/0.5);
    }
	return result;
}
