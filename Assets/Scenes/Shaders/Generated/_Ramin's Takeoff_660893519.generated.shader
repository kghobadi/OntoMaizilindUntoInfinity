...
uniform float2 x_1510573566_1ec48586_freq;
uniform float2 x_1510573566_1ec48586_extranoise;
...
uniform float4x4 _1510573566Matrix;
uniform float _1510573566MinScale;
uniform sampler2D x_1510573566_3f06f9be_textureMap;
uniform float x_1510573566_3f06f9be_textureMapSize;
uniform sampler2D x_1510573566_3f06f9be_bumpmap;
uniform float x_1510573566_3f06f9be_bumpfactor;
uniform float x_1510573566_3f06f9be_bumpmapsize;
uniform float4 x_1510573566_3f06f9be_color;
uniform float x_1510573566_3f06f9be_angle;
uniform float2 x_1510573566_3f06f9be_flatnessmask1;
uniform float2 x_1510573566_3f06f9be_flatnessmask2;
...
float3 MaterialFunc(float nf, inout float3 normal, float3 p, float3 rayDir, out float objectID)
{
    ...
    [branch] if (nf <= 1) {
    //    objectID = 1;
        return material_DesertMaterial(normal, objPos(_1510573566Matrix, p), rayDir, x_1510573566_3f06f9be_textureMap, x_1510573566_3f06f9be_textureMapSize, x_1510573566_3f06f9be_bumpmap, x_1510573566_3f06f9be_bumpfactor, x_1510573566_3f06f9be_bumpmapsize, x_1510573566_3f06f9be_color, x_1510573566_3f06f9be_angle, x_1510573566_3f06f9be_flatnessmask1, x_1510573566_3f06f9be_flatnessmask2);
    }
        objectID = 0;
...
{
    float _1510573566Distance = object_Desert(objPos(_1510573566Matrix, p), x_1510573566_1ec48586_freq, x_1510573566_1ec48586_extranoise) * _1510573566MinScale;
    result = float2(_1510573566Distance, /*material ID*/0.5);
    }
	return result;
}
