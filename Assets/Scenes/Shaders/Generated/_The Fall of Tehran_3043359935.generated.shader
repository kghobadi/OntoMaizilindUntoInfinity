...
uniform float2 x_3310150944_1ec48586_freq;
uniform float2 x_3310150944_1ec48586_extranoise;
...
uniform float4x4 _3310150944Matrix;
uniform float _3310150944MinScale;
uniform sampler2D x_3310150944_3f06f9be_textureMap;
uniform float x_3310150944_3f06f9be_textureMapSize;
uniform sampler2D x_3310150944_3f06f9be_bumpmap;
uniform float x_3310150944_3f06f9be_bumpfactor;
uniform float x_3310150944_3f06f9be_bumpmapsize;
uniform float4 x_3310150944_3f06f9be_color;
uniform float x_3310150944_3f06f9be_angle;
uniform float2 x_3310150944_3f06f9be_flatnessmask1;
uniform float2 x_3310150944_3f06f9be_flatnessmask2;
...
float3 MaterialFunc(float nf, inout float3 normal, float3 p, float3 rayDir, out float objectID)
{
    ...
    [branch] if (nf <= 1) {
    //    objectID = 1;
        return material_DesertMaterial(normal, objPos(_3310150944Matrix, p), rayDir, x_3310150944_3f06f9be_textureMap, x_3310150944_3f06f9be_textureMapSize, x_3310150944_3f06f9be_bumpmap, x_3310150944_3f06f9be_bumpfactor, x_3310150944_3f06f9be_bumpmapsize, x_3310150944_3f06f9be_color, x_3310150944_3f06f9be_angle, x_3310150944_3f06f9be_flatnessmask1, x_3310150944_3f06f9be_flatnessmask2);
    }
        objectID = 0;
...
{
    float _3310150944Distance = object_Desert(objPos(_3310150944Matrix, p), x_3310150944_1ec48586_freq, x_3310150944_1ec48586_extranoise) * _3310150944MinScale;
    result = float2(_3310150944Distance, /*material ID*/0,5);
    }
	return result;
}
