...
Shader "Hidden/_The Fall of Tehran_3043359935.generated"
{
...
uniform float2 x_2066443161_1ec48586_freq;
uniform float2 x_2066443161_1ec48586_extranoise;
...
uniform float4x4 _2066443161Matrix;
uniform float _2066443161MinScale;
uniform sampler2D x_2066443161_3f06f9be_textureMap;
uniform float x_2066443161_3f06f9be_textureMapSize;
uniform sampler2D x_2066443161_3f06f9be_bumpmap;
uniform float x_2066443161_3f06f9be_bumpfactor;
uniform float x_2066443161_3f06f9be_bumpmapsize;
uniform float4 x_2066443161_3f06f9be_color;
uniform float x_2066443161_3f06f9be_angle;
uniform float2 x_2066443161_3f06f9be_flatnessmask1;
uniform float2 x_2066443161_3f06f9be_flatnessmask2;
...
float3 MaterialFunc(float nf, inout float3 normal, float3 p, float3 rayDir, out float objectID)
{
    ...
    [branch] if (nf <= 1) {
    //    objectID = 1;
        return material_DesertMaterial(normal, objPos(_2066443161Matrix, p), rayDir, x_2066443161_3f06f9be_textureMap, x_2066443161_3f06f9be_textureMapSize, x_2066443161_3f06f9be_bumpmap, x_2066443161_3f06f9be_bumpfactor, x_2066443161_3f06f9be_bumpmapsize, x_2066443161_3f06f9be_color, x_2066443161_3f06f9be_angle, x_2066443161_3f06f9be_flatnessmask1, x_2066443161_3f06f9be_flatnessmask2);
    }
        objectID = 0;
...
{
    float _2066443161Distance = object_Desert(objPos(_2066443161Matrix, p), x_2066443161_1ec48586_freq, x_2066443161_1ec48586_extranoise) * _2066443161MinScale;
    result = float2(_2066443161Distance, /*material ID*/0,5);
    }
	return result;
}
