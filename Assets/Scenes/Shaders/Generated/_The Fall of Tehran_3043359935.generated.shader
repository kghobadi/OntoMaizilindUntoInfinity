...
uniform float2 x_108797813_1ec48586_freq;
uniform float2 x_108797813_1ec48586_extranoise;
...
uniform float4x4 _108797813Matrix;
uniform float _108797813MinScale;
uniform sampler2D x_108797813_3f06f9be_textureMap;
uniform float x_108797813_3f06f9be_textureMapSize;
uniform sampler2D x_108797813_3f06f9be_bumpmap;
uniform float x_108797813_3f06f9be_bumpfactor;
uniform float x_108797813_3f06f9be_bumpmapsize;
uniform float4 x_108797813_3f06f9be_color;
uniform float x_108797813_3f06f9be_angle;
uniform float2 x_108797813_3f06f9be_flatnessmask1;
uniform float2 x_108797813_3f06f9be_flatnessmask2;
...
float3 MaterialFunc(float nf, inout float3 normal, float3 p, float3 rayDir, out float objectID)
{
    ...
    [branch] if (nf <= 1) {
    //    objectID = 1;
        return material_DesertMaterial(normal, objPos(_108797813Matrix, p), rayDir, x_108797813_3f06f9be_textureMap, x_108797813_3f06f9be_textureMapSize, x_108797813_3f06f9be_bumpmap, x_108797813_3f06f9be_bumpfactor, x_108797813_3f06f9be_bumpmapsize, x_108797813_3f06f9be_color, x_108797813_3f06f9be_angle, x_108797813_3f06f9be_flatnessmask1, x_108797813_3f06f9be_flatnessmask2);
    }
        objectID = 0;
...
{
    float _108797813Distance = object_Desert(objPos(_108797813Matrix, p), x_108797813_1ec48586_freq, x_108797813_1ec48586_extranoise) * _108797813MinScale;
    result = float2(_108797813Distance, /*material ID*/0,5);
    }
	return result;
}
