...
uniform float2 x_2317949017_1ec48586_freq;
uniform float2 x_2317949017_1ec48586_extranoise;
...
uniform float4x4 _2317949017Matrix;
uniform float _2317949017MinScale;
uniform sampler2D x_2317949017_3f06f9be_textureMap;
uniform float x_2317949017_3f06f9be_textureMapSize;
uniform sampler2D x_2317949017_3f06f9be_bumpmap;
uniform float x_2317949017_3f06f9be_bumpfactor;
uniform float x_2317949017_3f06f9be_bumpmapsize;
uniform float4 x_2317949017_3f06f9be_color;
uniform float x_2317949017_3f06f9be_angle;
uniform float2 x_2317949017_3f06f9be_flatnessmask1;
uniform float2 x_2317949017_3f06f9be_flatnessmask2;
...
float3 MaterialFunc(float nf, inout float3 normal, float3 p, float3 rayDir, out float objectID)
{
    ...
    [branch] if (nf <= 1) {
    //    objectID = 1;
        return material_DesertMaterial(normal, objPos(_2317949017Matrix, p), rayDir, x_2317949017_3f06f9be_textureMap, x_2317949017_3f06f9be_textureMapSize, x_2317949017_3f06f9be_bumpmap, x_2317949017_3f06f9be_bumpfactor, x_2317949017_3f06f9be_bumpmapsize, x_2317949017_3f06f9be_color, x_2317949017_3f06f9be_angle, x_2317949017_3f06f9be_flatnessmask1, x_2317949017_3f06f9be_flatnessmask2);
    }
        objectID = 0;
...
{
    float _2317949017Distance = object_Desert(objPos(_2317949017Matrix, p), x_2317949017_1ec48586_freq, x_2317949017_1ec48586_extranoise) * _2317949017MinScale;
    result = float2(_2317949017Distance, /*material ID*/0.5);
    }
	return result;
}
