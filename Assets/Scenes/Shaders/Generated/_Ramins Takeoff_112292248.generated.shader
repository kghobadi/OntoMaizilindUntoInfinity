...
uniform float2 x_727150436_1ec48586_freq;
uniform float2 x_727150436_1ec48586_extranoise;
...
uniform float4x4 _727150436Matrix;
uniform float _727150436MinScale;
uniform sampler2D x_727150436_3f06f9be_textureMap;
uniform float x_727150436_3f06f9be_textureMapSize;
uniform sampler2D x_727150436_3f06f9be_bumpmap;
uniform float x_727150436_3f06f9be_bumpfactor;
uniform float x_727150436_3f06f9be_bumpmapsize;
uniform float4 x_727150436_3f06f9be_color;
uniform float x_727150436_3f06f9be_angle;
uniform float2 x_727150436_3f06f9be_flatnessmask1;
uniform float2 x_727150436_3f06f9be_flatnessmask2;
...
float3 MaterialFunc(float nf, inout float3 normal, float3 p, float3 rayDir, out float objectID)
{
    ...
    [branch] if (nf <= 1) {
    //    objectID = 1;
        return material_DesertMaterial(normal, objPos(_727150436Matrix, p), rayDir, x_727150436_3f06f9be_textureMap, x_727150436_3f06f9be_textureMapSize, x_727150436_3f06f9be_bumpmap, x_727150436_3f06f9be_bumpfactor, x_727150436_3f06f9be_bumpmapsize, x_727150436_3f06f9be_color, x_727150436_3f06f9be_angle, x_727150436_3f06f9be_flatnessmask1, x_727150436_3f06f9be_flatnessmask2);
    }
        objectID = 0;
...
{
    float _727150436Distance = object_Desert(objPos(_727150436Matrix, p), x_727150436_1ec48586_freq, x_727150436_1ec48586_extranoise) * _727150436MinScale;
    result = float2(_727150436Distance, /*material ID*/0,5);
    }
	return result;
}
