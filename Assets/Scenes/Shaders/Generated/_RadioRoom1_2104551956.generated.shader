/*
  ...
  for Raymarcher named 'Raymarcher' in scene 'RadioRoom1'.

*/


Shader "Hidden/_RadioRoom1_2104551956.generated"
{
...
uniform float2 x_1535633472_1ec48586_freq;
uniform float2 x_1535633472_1ec48586_extranoise;
...
uniform float4x4 _1535633472Matrix;
uniform float _1535633472MinScale;
uniform sampler2D x_1535633472_3f06f9be_textureMap;
uniform float x_1535633472_3f06f9be_textureMapSize;
uniform sampler2D x_1535633472_3f06f9be_bumpmap;
uniform float x_1535633472_3f06f9be_bumpfactor;
uniform float x_1535633472_3f06f9be_bumpmapsize;
uniform float4 x_1535633472_3f06f9be_color;
uniform float x_1535633472_3f06f9be_angle;
uniform float2 x_1535633472_3f06f9be_flatnessmask1;
uniform float2 x_1535633472_3f06f9be_flatnessmask2;
...
float3 MaterialFunc(float nf, inout float3 normal, float3 p, float3 rayDir, out float objectID)
{
    ...
    [branch] if (nf <= 1) {
    //    objectID = 1;
        return material_DesertMaterial(normal, objPos(_1535633472Matrix, p), rayDir, x_1535633472_3f06f9be_textureMap, x_1535633472_3f06f9be_textureMapSize, x_1535633472_3f06f9be_bumpmap, x_1535633472_3f06f9be_bumpfactor, x_1535633472_3f06f9be_bumpmapsize, x_1535633472_3f06f9be_color, x_1535633472_3f06f9be_angle, x_1535633472_3f06f9be_flatnessmask1, x_1535633472_3f06f9be_flatnessmask2);
    }
        objectID = 0;
...
{
    float _1535633472Distance = object_Desert(objPos(_1535633472Matrix, p), x_1535633472_1ec48586_freq, x_1535633472_1ec48586_extranoise) * _1535633472MinScale;
    result = float2(_1535633472Distance, /*material ID*/0.5);
    }
	return result;
}
