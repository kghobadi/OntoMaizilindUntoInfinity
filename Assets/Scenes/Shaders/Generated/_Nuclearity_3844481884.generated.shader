Shader "Hidden/_Nuclearity_3844481884.generated"
{
...
uniform int x_3547772883_1d0a4544_iterations;
uniform float x_3547772883_1d0a4544_bailout;
uniform float x_3547772883_1d0a4544_power;
...
uniform float4x4 _3547772883Matrix;
uniform float _3547772883MinScale;
uniform float2 x_3547772883_07ee3232_position;
uniform sampler2D x_3547772883_07ee3232_gradient;
...
float3 MaterialFunc(float nf, inout float3 normal, float3 p, float3 rayDir, out float objectID)
{
    ...
    [branch] if (nf <= 1) {
    //    objectID = 1;
        return material_Gradient(normal, objPos(_3547772883Matrix, p), rayDir, x_3547772883_07ee3232_position, x_3547772883_07ee3232_gradient);
    }
        objectID = 0;
...
{
    float _3547772883Distance = object_FractalMandelbub(objPos(_3547772883Matrix, p), x_3547772883_1d0a4544_iterations, x_3547772883_1d0a4544_bailout, x_3547772883_1d0a4544_power) * _3547772883MinScale;
    result = float2(_3547772883Distance, /*material ID*/0.5);
    }
	return result;
}
