...
uniform float2 x_47803637_1ec48586_freq;
uniform float2 x_47803637_1ec48586_extranoise;
...
uniform float4x4 _47803637Matrix;
uniform float _47803637MinScale;
uniform sampler2D x_47803637_3f06f9be_textureMap;
uniform float x_47803637_3f06f9be_textureMapSize;
uniform sampler2D x_47803637_3f06f9be_bumpmap;
uniform float x_47803637_3f06f9be_bumpfactor;
uniform float x_47803637_3f06f9be_bumpmapsize;
uniform float4 x_47803637_3f06f9be_color;
uniform float x_47803637_3f06f9be_angle;
uniform float2 x_47803637_3f06f9be_flatnessmask1;
uniform float2 x_47803637_3f06f9be_flatnessmask2;
...
float3 MaterialFunc(float nf, inout float3 normal, float3 p, float3 rayDir, out float objectID)
{
    ...
    [branch] if (nf <= 1) {
    //    objectID = 1;
        return material_DesertMaterial(normal, objPos(_47803637Matrix, p), rayDir, x_47803637_3f06f9be_textureMap, x_47803637_3f06f9be_textureMapSize, x_47803637_3f06f9be_bumpmap, x_47803637_3f06f9be_bumpfactor, x_47803637_3f06f9be_bumpmapsize, x_47803637_3f06f9be_color, x_47803637_3f06f9be_angle, x_47803637_3f06f9be_flatnessmask1, x_47803637_3f06f9be_flatnessmask2);
    }
        objectID = 0;
...
{
    float _47803637Distance = object_Desert(objPos(_47803637Matrix, p), x_47803637_1ec48586_freq, x_47803637_1ec48586_extranoise) * _47803637MinScale;
    result = float2(_47803637Distance, /*material ID*/0.5);
    }
	return result;
}
