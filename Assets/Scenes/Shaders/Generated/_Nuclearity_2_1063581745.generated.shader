Shader "Hidden/_Nuclearity_2_1063581745.generated"
{
...
uniform int x_3240964934_1d0a4544_iterations;
uniform float x_3240964934_1d0a4544_bailout;
uniform float x_3240964934_1d0a4544_power;
...
uniform float4x4 _3240964934Matrix;
uniform float _3240964934MinScale;
uniform float2 x_3240964934_07ee3232_position;
uniform sampler2D x_3240964934_07ee3232_gradient;
...
float3 MaterialFunc(float nf, inout float3 normal, float3 p, float3 rayDir, out float objectID)
{
    ...
    [branch] if (nf <= 1) {
    //    objectID = 1;
        return material_Gradient(normal, objPos(_3240964934Matrix, p), rayDir, x_3240964934_07ee3232_position, x_3240964934_07ee3232_gradient);
    }
        objectID = 0;
...
{
    float _3240964934Distance = object_FractalMandelbub(objPos(_3240964934Matrix, p), x_3240964934_1d0a4544_iterations, x_3240964934_1d0a4544_bailout, x_3240964934_1d0a4544_power) * _3240964934MinScale;
    result = float2(_3240964934Distance, /*material ID*/0,5);
    }
	return result;
}
