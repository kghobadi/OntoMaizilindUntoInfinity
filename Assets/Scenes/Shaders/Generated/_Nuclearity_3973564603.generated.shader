Shader "Hidden/_Nuclearity_3973564603.generated"
{
...
uniform int x_1506167412_1d0a4544_iterations;
uniform float x_1506167412_1d0a4544_bailout;
uniform float x_1506167412_1d0a4544_power;
...
uniform float4x4 _1506167412Matrix;
uniform float _1506167412MinScale;
uniform float2 x_1506167412_07ee3232_position;
uniform sampler2D x_1506167412_07ee3232_gradient;
...
float3 MaterialFunc(float nf, inout float3 normal, float3 p, float3 rayDir, out float objectID)
{
    ...
    [branch] if (nf <= 1) {
    //    objectID = 1;
        return material_Gradient(normal, objPos(_1506167412Matrix, p), rayDir, x_1506167412_07ee3232_position, x_1506167412_07ee3232_gradient);
    }
        objectID = 0;
...
{
    float _1506167412Distance = object_FractalMandelbub(objPos(_1506167412Matrix, p), x_1506167412_1d0a4544_iterations, x_1506167412_1d0a4544_bailout, x_1506167412_1d0a4544_power) * _1506167412MinScale;
    result = float2(_1506167412Distance, /*material ID*/0.5);
    }
	return result;
}
