Shader "Hidden/_Nuclearity_65845464.generated"
{
...
uniform int x_1510637829_1d0a4544_iterations;
uniform float x_1510637829_1d0a4544_bailout;
uniform float x_1510637829_1d0a4544_power;
...
uniform float4x4 _1510637829Matrix;
uniform float _1510637829MinScale;
uniform float2 x_1510637829_07ee3232_position;
uniform sampler2D x_1510637829_07ee3232_gradient;
...
float3 MaterialFunc(float nf, inout float3 normal, float3 p, float3 rayDir, out float objectID)
{
    ...
    [branch] if (nf <= 1) {
    //    objectID = 1;
        return material_Gradient(normal, objPos(_1510637829Matrix, p), rayDir, x_1510637829_07ee3232_position, x_1510637829_07ee3232_gradient);
    }
        objectID = 0;
...
{
    float _1510637829Distance = object_FractalMandelbub(objPos(_1510637829Matrix, p), x_1510637829_1d0a4544_iterations, x_1510637829_1d0a4544_bailout, x_1510637829_1d0a4544_power) * _1510637829MinScale;
    result = float2(_1510637829Distance, /*material ID*/0.5);
    }
	return result;
}
