Shader "Hidden/_5_Nuclearity_610190859.generated"
{
...
uniform int x_2878074679_1d0a4544_iterations;
uniform float x_2878074679_1d0a4544_bailout;
uniform float x_2878074679_1d0a4544_power;
...
uniform float4x4 _2878074679Matrix;
uniform float _2878074679MinScale;
uniform float2 x_2878074679_07ee3232_position;
uniform sampler2D x_2878074679_07ee3232_gradient;
...
float3 MaterialFunc(float nf, inout float3 normal, float3 p, float3 rayDir, out float objectID)
{
    ...
    [branch] if (nf <= 1) {
    //    objectID = 1;
        return material_Gradient(normal, objPos(_2878074679Matrix, p), rayDir, x_2878074679_07ee3232_position, x_2878074679_07ee3232_gradient);
    }
        objectID = 0;
...
{
    float _2878074679Distance = object_FractalMandelbub(objPos(_2878074679Matrix, p), x_2878074679_1d0a4544_iterations, x_2878074679_1d0a4544_bailout, x_2878074679_1d0a4544_power) * _2878074679MinScale;
    result = float2(_2878074679Distance, /*material ID*/0.5);
    }
	return result;
}
