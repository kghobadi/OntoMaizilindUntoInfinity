Shader "Hidden/_Nuclearity_359248471.generated"
{
...
uniform int x_1457185211_1d0a4544_iterations;
uniform float x_1457185211_1d0a4544_bailout;
uniform float x_1457185211_1d0a4544_power;
...
uniform float4x4 _1457185211Matrix;
uniform float _1457185211MinScale;
uniform float2 x_1457185211_07ee3232_position;
uniform sampler2D x_1457185211_07ee3232_gradient;
...
float3 MaterialFunc(float nf, inout float3 normal, float3 p, float3 rayDir, out float objectID)
{
    ...
    [branch] if (nf <= 1) {
    //    objectID = 1;
        return material_Gradient(normal, objPos(_1457185211Matrix, p), rayDir, x_1457185211_07ee3232_position, x_1457185211_07ee3232_gradient);
    }
        objectID = 0;
...
{
    float _1457185211Distance = object_FractalMandelbub(objPos(_1457185211Matrix, p), x_1457185211_1d0a4544_iterations, x_1457185211_1d0a4544_bailout, x_1457185211_1d0a4544_power) * _1457185211MinScale;
    result = float2(_1457185211Distance, /*material ID*/0.5);
    }
	return result;
}
