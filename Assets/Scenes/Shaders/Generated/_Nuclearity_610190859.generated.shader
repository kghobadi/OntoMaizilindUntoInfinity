...
uniform int x_3637589213_1d0a4544_iterations;
uniform float x_3637589213_1d0a4544_bailout;
uniform float x_3637589213_1d0a4544_power;
...
uniform float4x4 _3637589213Matrix;
uniform float _3637589213MinScale;
uniform float2 x_3637589213_07ee3232_position;
uniform sampler2D x_3637589213_07ee3232_gradient;
...
float3 MaterialFunc(float nf, inout float3 normal, float3 p, float3 rayDir, out float objectID)
{
    ...
    [branch] if (nf <= 1) {
    //    objectID = 1;
        return material_Gradient(normal, objPos(_3637589213Matrix, p), rayDir, x_3637589213_07ee3232_position, x_3637589213_07ee3232_gradient);
    }
        objectID = 0;
...
{
    float _3637589213Distance = object_FractalMandelbub(objPos(_3637589213Matrix, p), x_3637589213_1d0a4544_iterations, x_3637589213_1d0a4544_bailout, x_3637589213_1d0a4544_power) * _3637589213MinScale;
    result = float2(_3637589213Distance, /*material ID*/0.5);
    }
	return result;
}
