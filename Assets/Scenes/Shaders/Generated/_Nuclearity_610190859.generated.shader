...
uniform int x_742627844_1d0a4544_iterations;
uniform float x_742627844_1d0a4544_bailout;
uniform float x_742627844_1d0a4544_power;
...
uniform float4x4 _742627844Matrix;
uniform float _742627844MinScale;
uniform float2 x_742627844_07ee3232_position;
uniform sampler2D x_742627844_07ee3232_gradient;
...
float3 MaterialFunc(float nf, inout float3 normal, float3 p, float3 rayDir, out float objectID)
{
    ...
    [branch] if (nf <= 1) {
    //    objectID = 1;
        return material_Gradient(normal, objPos(_742627844Matrix, p), rayDir, x_742627844_07ee3232_position, x_742627844_07ee3232_gradient);
    }
        objectID = 0;
...
{
    float _742627844Distance = object_FractalMandelbub(objPos(_742627844Matrix, p), x_742627844_1d0a4544_iterations, x_742627844_1d0a4544_bailout, x_742627844_1d0a4544_power) * _742627844MinScale;
    result = float2(_742627844Distance, /*material ID*/0,5);
    }
	return result;
}
