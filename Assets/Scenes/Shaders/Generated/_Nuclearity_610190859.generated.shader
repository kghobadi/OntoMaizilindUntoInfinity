Shader "Hidden/_Nuclearity_610190859.generated"
{
...
uniform int x_1047227719_1d0a4544_iterations;
uniform float x_1047227719_1d0a4544_bailout;
uniform float x_1047227719_1d0a4544_power;
...
uniform float4x4 _1047227719Matrix;
uniform float _1047227719MinScale;
uniform float2 x_1047227719_07ee3232_position;
uniform sampler2D x_1047227719_07ee3232_gradient;
...
float3 MaterialFunc(float nf, inout float3 normal, float3 p, float3 rayDir, out float objectID)
{
    ...
    [branch] if (nf <= 1) {
    //    objectID = 1;
        return material_Gradient(normal, objPos(_1047227719Matrix, p), rayDir, x_1047227719_07ee3232_position, x_1047227719_07ee3232_gradient);
    }
        objectID = 0;
...
{
    float _1047227719Distance = object_FractalMandelbub(objPos(_1047227719Matrix, p), x_1047227719_1d0a4544_iterations, x_1047227719_1d0a4544_bailout, x_1047227719_1d0a4544_power) * _1047227719MinScale;
    result = float2(_1047227719Distance, /*material ID*/0.5);
    }
	return result;
}
