Shader "Hidden/_Nuclearity_230165752.generated"
{
...
uniform int x_1479203556_1d0a4544_iterations;
uniform float x_1479203556_1d0a4544_bailout;
uniform float x_1479203556_1d0a4544_power;
...
uniform float4x4 _1479203556Matrix;
uniform float _1479203556MinScale;
uniform float2 x_1479203556_07ee3232_position;
uniform sampler2D x_1479203556_07ee3232_gradient;
...
float3 MaterialFunc(float nf, inout float3 normal, float3 p, float3 rayDir, out float objectID)
{
    ...
    [branch] if (nf <= 1) {
    //    objectID = 1;
        return material_Gradient(normal, objPos(_1479203556Matrix, p), rayDir, x_1479203556_07ee3232_position, x_1479203556_07ee3232_gradient);
    }
        objectID = 0;
...
{
    float _1479203556Distance = object_FractalMandelbub(objPos(_1479203556Matrix, p), x_1479203556_1d0a4544_iterations, x_1479203556_1d0a4544_bailout, x_1479203556_1d0a4544_power) * _1479203556MinScale;
    result = float2(_1479203556Distance, /*material ID*/0.5);
    }
	return result;
}
