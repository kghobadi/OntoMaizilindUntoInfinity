...
uniform int x_47774801_1d0a4544_iterations;
uniform float x_47774801_1d0a4544_bailout;
uniform float x_47774801_1d0a4544_power;
...
uniform float4x4 _47774801Matrix;
uniform float _47774801MinScale;
uniform float2 x_47774801_07ee3232_position;
uniform sampler2D x_47774801_07ee3232_gradient;
...
float3 MaterialFunc(float nf, inout float3 normal, float3 p, float3 rayDir, out float objectID)
{
    ...
    [branch] if (nf <= 1) {
    //    objectID = 1;
        return material_Gradient(normal, objPos(_47774801Matrix, p), rayDir, x_47774801_07ee3232_position, x_47774801_07ee3232_gradient);
    }
        objectID = 0;
...
{
    float _47774801Distance = object_FractalMandelbub(objPos(_47774801Matrix, p), x_47774801_1d0a4544_iterations, x_47774801_1d0a4544_bailout, x_47774801_1d0a4544_power) * _47774801MinScale;
    result = float2(_47774801Distance, /*material ID*/0.5);
    }
	return result;
}
