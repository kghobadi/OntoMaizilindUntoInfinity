...
uniform float2 x_50604952_1ec48586_freq;
uniform float2 x_50604952_1ec48586_extranoise;
...
uniform float4x4 _50604952Matrix;
uniform float _50604952MinScale;
uniform sampler2D x_50604952_3f06f9be_textureMap;
uniform float x_50604952_3f06f9be_textureMapSize;
uniform sampler2D x_50604952_3f06f9be_bumpmap;
uniform float x_50604952_3f06f9be_bumpfactor;
uniform float x_50604952_3f06f9be_bumpmapsize;
uniform float4 x_50604952_3f06f9be_color;
uniform float x_50604952_3f06f9be_angle;
uniform float2 x_50604952_3f06f9be_flatnessmask1;
uniform float2 x_50604952_3f06f9be_flatnessmask2;
...
float3 MaterialFunc(float nf, inout float3 normal, float3 p, float3 rayDir, out float objectID)
{
    ...
    [branch] if (nf <= 1) {
    //    objectID = 1;
        return material_DesertMaterial(normal, objPos(_50604952Matrix, p), rayDir, x_50604952_3f06f9be_textureMap, x_50604952_3f06f9be_textureMapSize, x_50604952_3f06f9be_bumpmap, x_50604952_3f06f9be_bumpfactor, x_50604952_3f06f9be_bumpmapsize, x_50604952_3f06f9be_color, x_50604952_3f06f9be_angle, x_50604952_3f06f9be_flatnessmask1, x_50604952_3f06f9be_flatnessmask2);
    }
        objectID = 0;
...
{
    float _50604952Distance = object_Desert(objPos(_50604952Matrix, p), x_50604952_1ec48586_freq, x_50604952_1ec48586_extranoise) * _50604952MinScale;
    result = float2(_50604952Distance, /*material ID*/0.5);
    }
	return result;
}
