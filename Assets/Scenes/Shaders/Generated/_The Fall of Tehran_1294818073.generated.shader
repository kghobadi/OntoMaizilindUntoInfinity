...
uniform float2 x_49595189_1ec48586_freq;
uniform float2 x_49595189_1ec48586_extranoise;
...
uniform float4x4 _49595189Matrix;
uniform float _49595189MinScale;
uniform sampler2D x_49595189_3f06f9be_textureMap;
uniform float x_49595189_3f06f9be_textureMapSize;
uniform sampler2D x_49595189_3f06f9be_bumpmap;
uniform float x_49595189_3f06f9be_bumpfactor;
uniform float x_49595189_3f06f9be_bumpmapsize;
uniform float4 x_49595189_3f06f9be_color;
uniform float x_49595189_3f06f9be_angle;
uniform float2 x_49595189_3f06f9be_flatnessmask1;
uniform float2 x_49595189_3f06f9be_flatnessmask2;
...
float3 MaterialFunc(float nf, inout float3 normal, float3 p, float3 rayDir, out float objectID)
{
    ...
    [branch] if (nf <= 1) {
    //    objectID = 1;
        return material_DesertMaterial(normal, objPos(_49595189Matrix, p), rayDir, x_49595189_3f06f9be_textureMap, x_49595189_3f06f9be_textureMapSize, x_49595189_3f06f9be_bumpmap, x_49595189_3f06f9be_bumpfactor, x_49595189_3f06f9be_bumpmapsize, x_49595189_3f06f9be_color, x_49595189_3f06f9be_angle, x_49595189_3f06f9be_flatnessmask1, x_49595189_3f06f9be_flatnessmask2);
    }
        objectID = 0;
...
{
    float _49595189Distance = object_Desert(objPos(_49595189Matrix, p), x_49595189_1ec48586_freq, x_49595189_1ec48586_extranoise) * _49595189MinScale;
    result = float2(_49595189Distance, /*material ID*/0.5);
    }
	return result;
}
