...
uniform float2 x_50552124_1ec48586_freq;
uniform float2 x_50552124_1ec48586_extranoise;
...
uniform float4x4 _50552124Matrix;
uniform float _50552124MinScale;
uniform sampler2D x_50552124_3f06f9be_textureMap;
uniform float x_50552124_3f06f9be_textureMapSize;
uniform sampler2D x_50552124_3f06f9be_bumpmap;
uniform float x_50552124_3f06f9be_bumpfactor;
uniform float x_50552124_3f06f9be_bumpmapsize;
uniform float4 x_50552124_3f06f9be_color;
uniform float x_50552124_3f06f9be_angle;
uniform float2 x_50552124_3f06f9be_flatnessmask1;
uniform float2 x_50552124_3f06f9be_flatnessmask2;
...
float3 MaterialFunc(float nf, inout float3 normal, float3 p, float3 rayDir, out float objectID)
{
    ...
    [branch] if (nf <= 1) {
    //    objectID = 1;
        return material_DesertMaterial(normal, objPos(_50552124Matrix, p), rayDir, x_50552124_3f06f9be_textureMap, x_50552124_3f06f9be_textureMapSize, x_50552124_3f06f9be_bumpmap, x_50552124_3f06f9be_bumpfactor, x_50552124_3f06f9be_bumpmapsize, x_50552124_3f06f9be_color, x_50552124_3f06f9be_angle, x_50552124_3f06f9be_flatnessmask1, x_50552124_3f06f9be_flatnessmask2);
    }
        objectID = 0;
...
{
    float _50552124Distance = object_Desert(objPos(_50552124Matrix, p), x_50552124_1ec48586_freq, x_50552124_1ec48586_extranoise) * _50552124MinScale;
    result = float2(_50552124Distance, /*material ID*/0.5);
    }
	return result;
}
