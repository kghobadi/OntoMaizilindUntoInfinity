...
uniform float2 x_388567927_1ec48586_freq;
uniform float2 x_388567927_1ec48586_extranoise;
...
uniform float4x4 _388567927Matrix;
uniform float _388567927MinScale;
uniform sampler2D x_388567927_3f06f9be_textureMap;
uniform float x_388567927_3f06f9be_textureMapSize;
uniform sampler2D x_388567927_3f06f9be_bumpmap;
uniform float x_388567927_3f06f9be_bumpfactor;
uniform float x_388567927_3f06f9be_bumpmapsize;
uniform float4 x_388567927_3f06f9be_color;
uniform float x_388567927_3f06f9be_angle;
uniform float2 x_388567927_3f06f9be_flatnessmask1;
uniform float2 x_388567927_3f06f9be_flatnessmask2;
...
float3 MaterialFunc(float nf, inout float3 normal, float3 p, float3 rayDir, out float objectID)
{
    ...
    [branch] if (nf <= 1) {
    //    objectID = 1;
        return material_DesertMaterial(normal, objPos(_388567927Matrix, p), rayDir, x_388567927_3f06f9be_textureMap, x_388567927_3f06f9be_textureMapSize, x_388567927_3f06f9be_bumpmap, x_388567927_3f06f9be_bumpfactor, x_388567927_3f06f9be_bumpmapsize, x_388567927_3f06f9be_color, x_388567927_3f06f9be_angle, x_388567927_3f06f9be_flatnessmask1, x_388567927_3f06f9be_flatnessmask2);
    }
        objectID = 0;
...
{
    float _388567927Distance = object_Desert(objPos(_388567927Matrix, p), x_388567927_1ec48586_freq, x_388567927_1ec48586_extranoise) * _388567927MinScale;
    result = float2(_388567927Distance, /*material ID*/0.5);
    }
	return result;
}
