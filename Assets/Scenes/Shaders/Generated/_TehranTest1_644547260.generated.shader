...
uniform float2 x_50485997_1ec48586_freq;
uniform float2 x_50485997_1ec48586_extranoise;
...
uniform float4x4 _50485997Matrix;
uniform float _50485997MinScale;
uniform sampler2D x_50485997_3f06f9be_textureMap;
uniform float x_50485997_3f06f9be_textureMapSize;
uniform sampler2D x_50485997_3f06f9be_bumpmap;
uniform float x_50485997_3f06f9be_bumpfactor;
uniform float x_50485997_3f06f9be_bumpmapsize;
uniform float4 x_50485997_3f06f9be_color;
uniform float x_50485997_3f06f9be_angle;
uniform float2 x_50485997_3f06f9be_flatnessmask1;
uniform float2 x_50485997_3f06f9be_flatnessmask2;
...
float3 MaterialFunc(float nf, inout float3 normal, float3 p, float3 rayDir, out float objectID)
{
    ...
    [branch] if (nf <= 1) {
    //    objectID = 1;
        return material_DesertMaterial(normal, objPos(_50485997Matrix, p), rayDir, x_50485997_3f06f9be_textureMap, x_50485997_3f06f9be_textureMapSize, x_50485997_3f06f9be_bumpmap, x_50485997_3f06f9be_bumpfactor, x_50485997_3f06f9be_bumpmapsize, x_50485997_3f06f9be_color, x_50485997_3f06f9be_angle, x_50485997_3f06f9be_flatnessmask1, x_50485997_3f06f9be_flatnessmask2);
    }
        objectID = 0;
...
{
    float _50485997Distance = object_Desert(objPos(_50485997Matrix, p), x_50485997_1ec48586_freq, x_50485997_1ec48586_extranoise) * _50485997MinScale;
    result = float2(_50485997Distance, /*material ID*/0.5);
    }
	return result;
}
